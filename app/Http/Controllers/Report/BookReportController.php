...
class BookReportController extends Controller
{
    ...
    {
        $arr[10] =  DB::table('gbook_index')->whereYear('DATE_SAVE',$year-1)->whereMonth('DATE_SAVE','10')->count();
        $arr[11] =  DB::table('gbook_index')->whereYear('DATE_SAVE',$year-1)->whereMonth('DATE_SAVE','11')->count();
        $arr[12] =  DB::table('gbook_index')->whereYear('DATE_SAVE',$year-1)->whereMonth('DATE_SAVE','12')->count();
    ...
    {
        $arr[10] =  DB::table('gbook_index_inside')->whereYear('DATE_SAVE',$year-1)->whereMonth('DATE_SAVE','10')->count();
        $arr[11] =  DB::table('gbook_index_inside')->whereYear('DATE_SAVE',$year-1)->whereMonth('DATE_SAVE','11')->count();
        $arr[12] =  DB::table('gbook_index_inside')->whereYear('DATE_SAVE',$year-1)->whereMonth('DATE_SAVE','12')->count();
    ...
    public function countReceivebookUrgent($year)
    {
        ...
        foreach ($data as $value) {
            ...
            ->whereBetween('DATE_SAVE',[($year - 1) . '-10-01', $year . '-09-30'])->count();
        }
        return $arr;
    }
    public function countTypeebookreceive($year)
    {
        ...
        foreach ($data as $value) {
            ...
            $arr[$value->BOOK_TYPE_ID]['value'] = DB::table('gbook_index')->where('BOOK_TYPE_ID',$value->BOOK_TYPE_ID)->whereBetween('DATE_SAVE',[($year - 1) . '-10-01', $year . '-09-30'])->count();
        }
        return $arr;
    }
    ...
    public function countTypeebookreceive_byORG_all($year,$limit = 1000)
    {
        ...
        ->whereBetween('gbook_index.DATE_SAVE',[($year - 1) . '-10-01', $year . '-09-30'])
        ...
        foreach ($org_in as $value) {
            ...
            array_push($arr['content'][$org_id], DB::table('gbook_index')->where('BOOK_ORG_ID',$org_id)->where('BOOK_TYPE_ID',$value2->BOOK_TYPE_ID)->whereBetween('DATE_SAVE',[($year - 1) . '-10-01', $year . '-09-30'])->count());
            }
    ...
    public function countTypeebookreceive_byORG($year,$limit = 50)
    {
        ...
        foreach ($org_in as $value) {
            ...
            ->whereBetween('DATE_SAVE',[($year - 1) . '-10-01', $year . '-09-30'])->count(); //อื่น ๆ
