...
{       
    ...
    $to = date($displaydate_end);
    if($status == null){
        $infosupcon = Suppliescon::select('supplies_con.ID','supplies_status_regis.REGIS_STATUS_ID','CON_YEAR_ID','CON_NUM','supplies_con.REQUEST_ID','REGIS_STATUS_NAME','DATE_REGIS','EGP_PLAN_NAME','SUP_TYPE_NAME','VENDOR_NAME','supplies_con.BUDGET_SUM','supplies_budget.BUDGET_NAME','BUY_NAME','CHECK_DATE')
        ...
        ->orderBy('ID', 'desc')->get();
        $budgetsum =  Suppliescon::select('supplies_con.ID','supplies_status_regis.REGIS_STATUS_ID','CON_YEAR_ID','CON_NUM','supplies_con.REQUEST_ID','REGIS_STATUS_NAME','DATE_REGIS','EGP_PLAN_NAME','SUP_TYPE_NAME','VENDOR_NAME','supplies_con.BUDGET_SUM','supplies_budget.BUDGET_NAME','BUY_NAME','CHECK_DATE')
        ->leftJoin('supplies_status_regis','supplies_con.REGIS_STATUS_ID','=','supplies_status_regis.REGIS_STATUS_ID')
        ->leftJoin('supplies_type','supplies_con.SUP_TYPE_ID','=','supplies_type.SUP_TYPE_ID')
        ->leftJoin('supplies_request','supplies_con.REQUEST_ID','=','supplies_request.ID')
        ->leftJoin('supplies_buy','supplies_con.BUY_ID','=','supplies_buy.BUY_ID')
        ...
        $count =  Suppliescon::select('supplies_con.ID','supplies_status_regis.REGIS_STATUS_ID','CON_YEAR_ID','CON_NUM','supplies_con.REQUEST_ID','REGIS_STATUS_NAME','DATE_REGIS','EGP_PLAN_NAME','SUP_TYPE_NAME','VENDOR_NAME','supplies_con.BUDGET_SUM','supplies_budget.BUDGET_NAME','BUY_NAME','CHECK_DATE')
        ->leftJoin('supplies_status_regis','supplies_con.REGIS_STATUS_ID','=','supplies_status_regis.REGIS_STATUS_ID')
        ->leftJoin('supplies_type','supplies_con.SUP_TYPE_ID','=','supplies_type.SUP_TYPE_ID')
        ->leftJoin('supplies_request','supplies_con.REQUEST_ID','=','supplies_request.ID')
        ->leftJoin('supplies_buy','supplies_con.BUY_ID','=','supplies_buy.BUY_ID')
...
public function infofoodbilltotal_orders(Request $request,$idlistref)
{
    ...
    ->where('QUOTATION_CON_NUM','=',$infosuppliecon->CON_NUM)->where('QUOTATION_WIN','=',1)->first();
       ...
       if($maxnum->PO_NUM == '' || $maxnum->PO_NUM == null){
        $lastnum_num = 1;
       }else{
