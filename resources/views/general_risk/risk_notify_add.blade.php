                    ...
                    <div class="row">
                        ...
                        <div>
                            <a href="{{ url('general_risk/risk_notify/' . $inforpersonuserid->ID) }}"
                                ...
                                style="font-family: 'Kanit', sans-serif; font-size: 10px;font-size: 1.0rem;font-weight:normal;">รายงานความเสี่ยง</a>
                        </div>
                        <div>&nbsp;</div>
...
<input value="{{$id_user}}" type="hidden" name="USER_ID"  id="USER_ID" class="form-control input-lg"  >                                                                 
    ...
    <div class="row push">
        ...
        <div class="col-sm-1">
            ...
            <div class="row push">
                ...
                <div class="col-sm-2">
                    <label for="RISKREP_TYPE" style="font-family:'Kanit',sans-serif;font-size:13px;">สถานที่เกิดเหตุ</label><label style="color: red;">** &nbsp;</label>
                    </div> 
                    <div class="col-lg-3 ">
    ...
    <div class="row push">
        ...
        <div class="col-lg-10 ">
            <p style="font-family:'Kanit',sans-serif;font-size:13px;text-align:left">บรรยายรายละเอียดเหตุการณ์ เพื่อไห้ทราบว่า เกิดอะไร ที่ไหน อย่างไร วันที่ เวลา สถานที่ ผู้ประสบเหตุเป็นต้น</p>  
