...
?>
                    ...
                    <div class="content">
                        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <a href="{{ url('general_document/genodocdocumentinside/'.$inforpersonuserid -> ID)}}" class="btn btn-warning loadscreen" style="font-family: 'Kanit', sans-serif; font-size: 10px;font-size: 1.0rem;font-weight:normal;">หนังสือส่ง
                ...
                <div class="content">
                        ...
                        <form action="{{ route('mbook.insidedocsearch',['iduser'=>  $inforpersonuserid->ID]) }}" method="post">
@csrf
             ...
             <div class="table-responsive">
                            ...
                            <table class="gwt-table table-striped table-vcenter js-dataTable-simple" style="width: 100%;">
                                <thead style="background-color: #FFEBCD;">
                                    ...
                                    {{-- <th  class="text-font" style="border-color:#F0FFFF;text-align: center;border: 1px solid black;" width="10%">อ่าน</th> --}}
                                    <th  class="text-font" style="border-color:#F0FFFF;text-align: center;border: 1px solid black;" width="15%">เลขที่หนังสือส่ง</th>
                                ...
                                <tr height="20">
                                        ...
                                        <td  style="border-color:#F0FFFF;text-align: center;border: 1px solid black;"><span class="btn" style="background-color:#0000FF;color:#F0FFFF;"><i class="fa fa-1.5x fa-paperclip"></i></span></td>
                                        @else
                                        <td  style="border-color:#F0FFFF;text-align: center;border: 1px solid black;"></td>
                                        @endif
                                       ...
                                       <td class="text-font" style="border-color:#F0FFFF;text-align: center;border: 1px solid black;"></td>
                                        ...
                                        <td  style="border-color:#F0FFFF;text-align: center;border: 1px solid black;"><span class="btn" style="background-color:#32CD32;color:#F0FFFF;"><i class="si si-book-open"></i></span></td>
                                        @else
                                        <td  style="border-color:#F0FFFF;text-align: center;border: 1px solid black;"><span class="btn" style="background-color:#DCDCDC;color:#F0FFFF;"><i class="si si-book-open"></i></span></td>
                                        @endif --}}
                                        ...
                                        <td class="text-font text-pedding" style="border-color:#F0FFFF;text-align: left;border: 1px solid black;">{{$inforbook->RECORD_ORG_NAME}}</td>
                                        ...
                                        <button type="button" class="btn btn-outline-info dropdown-toggle" id="dropdown-align-outline-info" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="font-family: 'Kanit', sans-serif; font-size: 10px;font-weight:normal;">
                                                ...
                                                <div class="dropdown-menu" style="width:10px">
                                                    <a class="dropdown-item"  href="{{ url('general_document/genodocdocumentinside/control/'.$inforbook->BOOK_ID.'/'.$inforpersonuserid->ID) }}"  style="font-family: 'Kanit', sans-serif; font-size: 13px;font-weight:normal;" onclick="checkreadinside({{$inforbook->BOOK_ID}},{{$inforpersonuserid->ID}});">อ่าน/จัดการหนังสือ</a>
                                    ...
                                    <tr height="40">
                                       ...
                                       <td class="text-font" align="center" ></td>
                                        ...
                                        <td class="text-font text-pedding" >{{ $inforbook->BOOK_NUMBER}}</td>
                                        ...
                                        <td class="text-font" align="center">{{ DateThai($inforbook->DATE_SAVE)}}</td>
                                        ...
                                        <button type="button" class="btn btn-outline-info dropdown-toggle" id="dropdown-align-outline-info" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="font-family: 'Kanit', sans-serif; font-size: 10px;font-weight:normal;">
                                                ...
                                                <div class="dropdown-menu" style="width:10px">
                                                    <a class="dropdown-item"  href="{{ url('general_document/genodocdocumentinside/control/'.$inforbook->BOOK_ID.'/'.$inforpersonuserid->ID) }}"  style="font-family: 'Kanit', sans-serif; font-size: 15px;font-weight:normal;" onclick="checkreadinside({{$inforbook->BOOK_ID}},{{$inforpersonuserid->ID}});">อ่าน/จัดการหนังสือ</a>
                            ...
                            <tr height="40">
                                       ...
                                       <td class="text-font" align="center" ></td>
                                        ...
                                        <td class="text-font text-pedding" >{{ $inforbook->BOOK_NUMBER}}</td>
                                        <td class="text-font text-pedding" >{{ $inforbook->BOOK_NAME}}</td>
                                        <td class="text-font" align="center">{{ DateThai($inforbook->DATE_SAVE)}}</td>
...
function checkreadinside(bookid,userid){



          var _token=$('input[name="_token"]').val();
           $.ajax({
                   url:"{{route('document.checkreadinside')}}",
                   method:"GET",
