...
?>
                    ...
                    <div class="content">
                        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <a href="{{ url('general_document/genodocdocumentannounce/'.$inforpersonuserid -> ID)}}" class="btn btn-info loadscreen" style="font-family: 'Kanit', sans-serif; font-size: 10px;font-size: 1.0rem;font-weight:normal;">ประกาศ
                ...
                <div class="content">
                        ...
                        <form action="{{ route('document.announcedocsearch',['iduser'=>  $inforpersonuserid->ID]) }}" method="post">
@csrf
                            ...
                            <table class="gwt-table table-striped table-vcenter js-dataTable-simple" style="width: 100%;">
                                <thead style="background-color: #FFEBCD;">
                                    ...
                                    <th  class="text-font" style="border-color:#F0FFFF;text-align: center;border: 1px solid black;" width="5%">อ่าน</th>
                                     <th  class="text-font" style="border-color:#F0FFFF;text-align: center;border: 1px solid black;" width="10%">ชื่อเรื่อง</th>
                                     <th  class="text-font" style="border-color:#F0FFFF;text-align: center;border: 1px solid black;" width="35%">รายละเอียด</th>
                                ...
                                <tr height="20">
                                        ...
                                        <button type="button" class="btn btn-outline-info dropdown-toggle" id="dropdown-align-outline-info" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="font-family: 'Kanit', sans-serif; font-size: 10px;font-weight:normal;">
                                                ...
                                                <div class="dropdown-menu" style="width:10px">
                                                    <a class="dropdown-item"  href="{{ url('general_document/genodocdocumentannounce/control/'.$inforbook->BOOK_ID.'/'.$inforpersonuserid->ID) }}"  style="font-family: 'Kanit', sans-serif; font-size: 13px;font-weight:normal;" onclick="checkreadannounce({{$inforbook->BOOK_ID}},{{$inforpersonuserid->ID}});">อ่าน/จัดการหนังสือ</a>
...
function checkreadannounce(bookid,userid){

      var _token=$('input[name="_token"]').val();
       $.ajax({
               url:"{{route('document.checkreadannounce')}}",
               method:"GET",
