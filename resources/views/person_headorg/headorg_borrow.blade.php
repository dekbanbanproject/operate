                       ...
                       <?php $number = 0; ?>
                                ...
                                <?php $number++; ?>
                                    ...
                                    <tr height="40">
                                        ...
                                        <td class="text-font text-pedding" style="text-align: center">{{ DateThai($inforSalaryborrow->BORROW_DATE)}}</td>
                                        <td></td>
                                      
                                        <td class="text-font text-pedding" > {{ $inforSalaryborrow->BORROW_COMMENT}}</td>                                       
                                        <td class="text-font text-pedding" style="text-align: left">{{ $inforSalaryborrow->BORROW_HR_DEP_SUB_SUB_NAME}}</td>
                                        <td class="text-font text-pedding" style="text-align: left">{{ $inforSalaryborrow->BORROW_HR_PERSON_NAME}}</td>
