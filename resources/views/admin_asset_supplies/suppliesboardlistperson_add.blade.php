...
?>
                ...
                <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;"><i class="fas fa-plus"></i> เพิ่มข้อมูลกรรมการ</h2>    

    
        <form  method="post" action="{{ route('admin.savesuppliesboardlistperson') }}" enctype="multipart/form-data">
        @csrf
        <div class="row push">
