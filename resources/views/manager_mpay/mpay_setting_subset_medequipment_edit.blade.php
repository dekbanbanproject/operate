            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        <label for="STORE_ID">ทะเบียนวัสดุ</label> <span class="text-danger">*</span> 
                        <select class="js-select2 form-control" id="STORE_ID" name="STORE_ID"
                            ...
                            <?php
                                    ...
                                    ?>
                            @if($subsetequp->STORE_ID === $row->STORE_ID)
                            <option value="{{$row->STORE_ID}}" data-record="{{$data_record}}" selected>
                    ...
                    <div class="form-group">
                        <label for="STORE_CODE">เลขทะเบียนวัสดุ</label> <span class="text-danger">*</span>
                        <input type="text" class="js-maxlength form-control f-kanit js-maxlength-enabled"
                            id="STORE_CODE" name="STORE_CODE" maxlength="255" placeholder="เลขทะเบียนวัสดุ"
                            readonly required value="{{$subsetequp->STORE_CODE}}">
                    </div>
                    <div class="form-group">
                        ...
                        <input type="number" class="js-maxlength form-control f-kanit js-maxlength-enabled"
                            id="CPAY_SET_SUB_PRICE" name="CPAY_SET_SUB_PRICE" min="0" placeholder="ราคา"
                            required value="{{$subsetequp->CPAY_SET_SUB_PRICE}}">
                    </div>
                    <div class="form-group">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="js-maxlength form-control f-kanit js-maxlength-enabled"
                            id="CPAY_SET_SUB_NAME_INSIDE" name="CPAY_SET_SUB_NAME_INSIDE" maxlength="255" placeholder="ชื่อภายใน"
                            required value="{{$subsetequp->CPAY_SET_SUB_NAME_INSIDE}}">
                    </div>
                    <div class="form-group">
                        <label for="CPAY_SET_SUB_NAME_TH">ชื่อไทย</label> <span class="text-danger">*</span>
                        <input type="text" class="js-maxlength form-control f-kanit js-maxlength-enabled"
                            id="CPAY_SET_SUB_NAME_TH" name="CPAY_SET_SUB_NAME_TH" maxlength="255" placeholder="ชื่อไทย" required value="{{$subsetequp->CPAY_SET_SUB_NAME_TH}}">
                    </div>
                    <div class="form-group">
                        <label for="CPAY_SET_SUB_NAME_EN">ชื่ออังกฤษ</label>
                        <input type="text" class="js-maxlength form-control f-kanit js-maxlength-enabled"
                            id="CPAY_SET_SUB_NAME_EN" name="CPAY_SET_SUB_NAME_EN" maxlength="255" placeholder="ชื่ออังกฤษ" value="{{$subsetequp->CPAY_SET_SUB_NAME_EN}}">
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <textarea type="text" style="height:90px;"
                            ...
                            name="CPAY_SET_SUB_DETAIL" maxlength="255" placeholder="รายละเอียด...">{{$subsetequp->CPAY_SET_SUB_DETAIL}}</textarea>
                    </div>
                </div>
            </div>
            <div class="row items-push">
