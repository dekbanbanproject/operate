...
<div class="block block-rounded block-bordered" style="width: 95%;margin:auto">
    <div class="block-header block-header-default">
        ...
        <h3 class="block-options text-center fw-8"><a target="_bank" href="{{route('mpay.mpay_show_quota')}}" class="btn btn-sm btn-primary f-kanit">โควต้าชุดอุปรกรณ์แต่ละหน่วย</a></h3>
    </div>
                ...
                @csrf
                    ...
                    <div class="row items-push">
                        <div class="col-lg-12 d-flex justify-content-end">
                            <button type="submit" class="submit_click btn btn-sm btn-primary f-kanit mr-1">พิมพ์สติ๊กเกอร์</button>
                            <a onclick="return confirm('ต้องการยกเลิกจริงใช่หรือไม่?')" href="{{route('mpay.mpay_service_stickerprint')}}" type="submit" class="submit_click btn btn-sm btn-danger f-kanit">ยกเลิก</a>
                        </div>
                    </div>
                </form>
    </div>
