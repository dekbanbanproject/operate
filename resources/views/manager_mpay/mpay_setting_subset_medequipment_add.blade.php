...
<div class="block block-rounded block-bordered" style="width: 95%;margin:auto">
    <div class="block-header block-header-default">
        <h3 class="block-title">เพิ่มเครื่องมือวัสดุ</h3>
    </div>
    <div class="block-content">
        <form action="{{route('mpay.mpay_setting_subset_medequipment_save')}}" method="POST">
            @csrf
            <!-- Basic Elements -->
            <div class="row">
                <div class="col-lg-6">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="js-maxlength form-control f-kanit js-maxlength-enabled"
                            id="CPAY_SET_SUB_NAME_EN" name="CPAY_SET_SUB_NAME_EN" maxlength="255" placeholder="ชื่ออังกฤษ">
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <textarea type="text" style="height:90px;"
                            ...
                            name="CPAY_SET_SUB_DETAIL" maxlength="255" placeholder="รายละเอียด..."></textarea>
                    </div>
                </div>
            </div>
            <div class="row items-push">
