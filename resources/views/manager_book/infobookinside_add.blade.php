...
<h3 class="block-title" style="font-family: 'Kanit', sans-serif;"><B>ออกเลขทะเบียนหนังสือส่ง</B></h3>

</div>
<form  method="post" id="form_add" action="{{ route('mbook.infobookoutsave') }}"  enctype="multipart/form-data"  class="needs-validation" novalidate>      
    @csrf
...
<div style='overflow:scroll; width:auto;height:900px;  background-color: #404040;' id="pages"></div>
   ...
   วันที่บันทึก  {{$datenow}}
        ...
        <div class="row">
            ...
            <input  name = "BOOK_NUM_IN"  id="BOOK_NUM_IN" class="form-control input-sm {{ $errors->has('BOOK_NUM_IN') ? 'is-invalid' : '' }}" style=" font-family: 'Kanit', sans-serif;" value="{{$maxnumberuse}}">
            </div>
            <div class="col-md-3">
            <p style="text-align: left">ปี พ.ศ.</p>
            </div>
            <div class="col-md-3">
            <select name="BOOK_YEAR_ID" id="BOOK_YEAR_ID" class="form-control input-sm {{ $errors->has('BOOK_YEAR_ID') ? 'is-invalid' : '' }}" style=" font-family: 'Kanit', sans-serif;" onchange="checkmaxinside();">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
            <select name="BOOK_URGENT_ID" id="BOOK_URGENT_ID" class="form-control input-sm {{ $errors->has('BOOK_URGENT_ID') ? 'is-invalid' : '' }}" style=" font-family: 'Kanit', sans-serif;" >
            ...
            <div class="col-md-3">
            <select name="BOOK_SECRET_ID" id="BOOK_SECRET_ID" class="form-control input-sm {{ $errors->has('BOOK_SECRET_ID') ? 'is-invalid' : '' }}" style=" font-family: 'Kanit', sans-serif;" >
        ...
        <div class="row">
            ...
            <div class="col-md-3">
            <input  name = "BOOK_DATE"  id="BOOK_DATE" class="form-control input-sm datepicker {{ $errors->has('BOOK_DATE') ? 'is-invalid' : '' }}" style=" font-family: 'Kanit', sans-serif;" value="{{formate(date('Y-m-d'))}}" readonly>
            </div>
            <div class="col-md-3">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
            <input  name = "BOOK_NUMBER"  id="BOOK_NUMBER" class="form-control input-sm {{ $errors->has('BOOK_NUMBER') ? 'is-invalid' : '' }}" style=" font-family: 'Kanit', sans-serif;" >
            </div>
        </div>
        <div class="row">
            <div class="col">
...
<div class="modal-footer">
        ...
        <a href="{{ url('manager_book/bookinside')  }}" class="btn btn-hero-sm btn-hero-danger" style="font-family: 'Kanit', sans-serif;font-weight:normal;" onclick="return confirm('ต้องการที่จะยกเลิกการเพิ่มข้อมูล ?')" ><i class="fas fa-window-close"></i> &nbsp;ยกเลิก</a> --}}
...
function checkmaxinside(){
      ...
      //alert(record_location);
          ...
          var _token=$('input[name="_token"]').val();
           $.ajax({
                   url:"{{route('mbook.checkmaxinside')}}",
                   method:"GET",
