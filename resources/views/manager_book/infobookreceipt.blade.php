...
&nbsp;
<a href="{{ url('manager_book/bookreceipt_excel') }}"  class="btn btn-hero-sm btn-hero-success" style="font-family: 'Kanit', sans-serif;font-weight:normal;"><i class="fas fa-file-excel mr-2"></i>Excel</a>
</div>
                                          ...
                                          @if($infobookreceipt->BOOK_SECRET_ID == 1)
                                                <tr height="20">
                                                  ...
                                                  <td class="text-font" style="border-color:#F0FFFF;text-align: center;border: 1px solid black;"></td>
                                                    ...
                                                    <td class="text-font text-pedding" style="border-color:#F0FFFF;text-align: left;border: 1px solid black;"  valign="top" width="8%">{{ $infobookreceipt->BOOK_NUM_IN}}</td>
                                          ...
                                          @else
                                              ...
                                              <tr height="40">
                                                  ...
                                                  <td class="text-font" style="border-color:#F0FFFF;text-align: center;border: 1px solid black;"></td>
                                                    ...
                                                    <td class="text-font text-pedding" style="color: red;border: 1px solid black;">ลับ :: {{ $infobookreceipt->BOOK_NAME}}</td>
                                                    @elseif($infobookreceipt->BOOK_SECRET_ID == 3)
                                                    <td class="text-font text-pedding" style="color: red;border: 1px solid black;">ลับมาก :: {{ $infobookreceipt->BOOK_NAME}}</td>
                                                    @elseif($infobookreceipt->BOOK_SECRET_ID == 4)
                                                    <td class="text-font text-pedding" style="color: red;border: 1px solid black;">ลับที่สุด :: {{ $infobookreceipt->BOOK_NAME}}</td>
                                                    @else
                                                    <td class="text-font text-pedding" style="color: red;border: 1px solid black;"> {{ $infobookreceipt->BOOK_NAME}}</td>
                                                    @endif
