...
<h3 class="block-title" style="font-family: 'Kanit', sans-serif;"><B>แก้ไขทะเบียนหนังสือรับ</B></h3>

</div>
<form  method="post" action="{{ route('mbook.infobookreceiptupdate') }}"  enctype="multipart/form-data"  class="needs-validation" novalidate>      
    @csrf
...
@endif
   ...
   วันที่แก้ไขบันทึกรับ  {{$datenow}}
        ...
        <div class="row">
            ...
            <div class="col-md-3">
            <input  name = "BOOK_DATE_EXPIRE"  id="BOOK_DATE_EXPIRE" class="form-control input-sm datepicker {{ $errors->has('BOOK_DATE_EXPIRE') ? 'is-invalid' : '' }}" style=" font-family: 'Kanit', sans-serif;" value="{{formate($infobookedit->BOOK_DATE_EXPIRE)}}" readonly>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-9">
            <input  name = "BOOK_REFER_NUM_1"  id="BOOK_REFER_NUM_1" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" value="{{$infobookedit->BOOK_REFER_NUM_1}}">
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-9">
            <input  name = "BOOK_REFER_DATE_1"  id="BOOK_REFER_DATE_1" class="form-control input-sm datepicker" style=" font-family: 'Kanit', sans-serif;" value="{{formate($infobookedit->BOOK_REFER_DATE_1)}}" readonly>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-9">
            <input  name = "BOOK_REFER_NAME_1"  id="BOOK_REFER_NAME_1" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;"  value="{{$infobookedit->BOOK_REFER_NAME_1}}">
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-9">
            <input  name = "BOOK_REFER_NUM_2"  id="BOOK_REFER_NUM_2" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" value="{{$infobookedit->BOOK_REFER_NUM_2}}">
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-9">
              ...
              <input  name = "BOOK_REFER_DATE_2"  id="BOOK_REFER_DATE_2" class="form-control input-sm datepicker" style=" font-family: 'Kanit', sans-serif;" value="{{ formate($infobookedit->BOOK_REFER_DATE_2)}}" readonly>
        ...
        <div class="row">
            ...
            <div class="col-md-9">
            <input  name = "BOOK_REFER_NAME_2"  id="BOOK_REFER_NAME_2" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;"  value="{{$infobookedit->BOOK_REFER_NAME_2}}">
            </div>
...
{{--         
        <span type="button"  class="btn btn-hero-sm btn-hero-info btn-submit-edit" style="font-family: 'Kanit', sans-serif;font-weight:normal;"><i class="fas fa-save"></i> &nbsp;บันทึกข้อมูล</span>
        <a href="{{ url('manager_book/bookreceipt')  }}" class="btn btn-hero-sm btn-hero-danger" style="font-family: 'Kanit', sans-serif;font-weight:normal;" onclick="return confirm('ต้องการที่จะยกเลิกการแก้ไขข้อมูล ?')" ><i class="fas fa-window-close"></i> &nbsp;ยกเลิก</a>
