...
<div class="row">
   ...
   <!--<a class="btn btn-hero-sm btn-hero-info"  href="#detail_pdf"  data-toggle="modal"  style="font-family: 'Kanit', sans-serif; font-size: 15px;font-weight:normal;" >ZOOM</a>-->
   ...
   @endif
                                        ...
                                        <div id="detail_pdf" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                                            <div class="modal-dialogr" style="width:100%">
   ...
   <input type="hidden" name="SEND_BY_NAME" id="SEND_BY_NAME" value="{{ $infobooksend -> HR_FNAME }}  {{ $infobooksend -> HR_LNAME }}">
...
<div class="modal-footer">
        ...
        @if($checkmanagerbookoffer != 0)
                    ...
                    <button type="submit" name = "SUBMIT"  value="sendhead" class="btn btn-hero-sm btn-hero-success">เสนอ ผอ.</button>
                    @endif

            <button type="submit" name = "SUBMIT"  value="sendsave" class="btn btn-hero-sm btn-hero-info" >บันทึกส่งหนังสือ</button>
        @endif
        <a  onclick="window.history.back()" class="btn btn-hero-sm btn-hero-danger"  style="font-family: 'Kanit', sans-serif; font-size: 10px;font-size: 1.0rem;font-weight:normal;color:#FFFFFF;">ยกเลิก</a>
...
@csrf
    ...
    @if($sendleaderdetail !== '')
        ...
        <button type="submit"  class="btn btn-hero-sm btn-hero-info" >บันทึกความเห็น</button>
...
<div id="retire_modal" class="modal fade edit" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
   ...
   <form action="{{ route('mbook.saveretire') }}" method="post">
@csrf
