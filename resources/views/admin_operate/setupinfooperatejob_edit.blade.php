...
?>
        ...
        <form  method="post" action="{{ route('admin.updateoperatejob') }}" enctype="multipart/form-data">
        @csrf
        <div class="row push">
       ...
       <div class="col-lg-3">
         <input  name = "OPERATE_JOB_NAME"  id="OPERATE_JOB_NAME" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{ $infooperatejob->OPERATE_JOB_NAME}}" onkeyup="check_operate_job_name();">
       ...
       <div class="col-lg-1">
        ...
        <div class="col-lg-1">
         <input type="text" class="js-masked-time form-control" id="OPERATE_JOB_TIMEBIGEN" name="OPERATE_JOB_TIMEBIGEN" style=" font-family: 'Kanit', sans-serif;" placeholder="00:00" value="{{ $infooperatejob->OPERATE_JOB_TIMEBIGEN}}" onchange="check_operate_job_timebigen();">
        ...
        <div class="col-lg-1"> 
         ...
         <div class="col-lg-1"> 
         <input type="text" class="js-masked-time form-control" id="OPERATE_JOB_TIMEEND" name="OPERATE_JOB_TIMEEND" style=" font-family: 'Kanit', sans-serif;" placeholder="00:00" value="{{ $infooperatejob->OPERATE_JOB_TIMEEND}}" onchange="check_operate_job_timeend();">
         ...
         <select name="OPERATE_DEPARTMENT_SUB_SUB_ID" id="OPERATE_DEPARTMENT_SUB_SUB_ID" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onchange="check_operate_department_subsub_id();">
           <option value="" selected>--กรุณาเลือกหน่วยงาน--</option>
                               @foreach ($hrd_departments as $hrd_department)
                                  @if($hrd_department -> HR_DEPARTMENT_SUB_SUB_ID == $infooperatejob->OPERATE_DEPARTMENT_SUB_SUB_ID)
                                  <option value="{{ $hrd_department -> HR_DEPARTMENT_SUB_SUB_ID }}" selected>{{ $hrd_department -> HR_DEPARTMENT_SUB_SUB_NAME }}</option> 
                                  @else                     
      ...
      <div class="row push">
       ...
       <div class="col-lg-1">
         ...
         <div class="col-lg-3">
            <input  name = "OPERATE_JOB_MONEY"  id="OPERATE_JOB_MONEY" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="check_operate_job_money();chkmunny()" value="{{ $infooperatejob->OPERATE_JOB_MONEY}}">
        ...
        <div class="col-lg-3">
           ...
           <option value="" selected>--กรุณาเลือกประเภทเวร--</option>
                               @foreach ($operatetypes as $operatetype)   
                                  @if($operatetype -> OPERATE_TYPE_ID == $infooperatejob->OPERATE_JOB_TYPE_ID)                 
 ...
 <div class="col-lg-1"> 
   ...
   <div class="col-lg-3"> 
            ...
            <input  name = "OPERATE_JOB_DETAIL"  id="OPERATE_JOB_DETAIL" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{ $infooperatejob->OPERATE_JOB_DETAIL}}" onkeyup="check_operate_job_detail();">
       ...
       <div class="col-lg-1">
        ...
        <option value="">--กรุณาเลือกสีเวร-</option>
                            @foreach ($operatecolors as $operatecolor) 
                              @if($operatecolor -> OPERATE_COLOR_CODE == $infooperatejob->OPERATE_JOB_COLOR)
                              <option value="{{ $operatecolor -> OPERATE_COLOR_CODE }}" style="background-color: {{$operatecolor -> OPERATE_COLOR_CODE }}; " selected><div style="background-color: {{$operatecolor -> OPERATE_COLOR_CODE }}; "></div>{{ $operatecolor -> OPERATE_COLOR_NAME }}</option>           
                              @else
        ...
        <div style="color: red; font-size: 16px;" id="operate_job_color"></div>
          ...
          <input type="hidden" name = "OPERATE_JOB_ID"  id="OPERATE_JOB_ID" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{ $infooperatejob->OPERATE_JOB_ID}}">
         </div>   
        <div class="modal-footer">
        <div align="right">
        <button type="submit"  class="btn btn-hero-sm btn-hero-info" >บันทึกแก้ไขข้อมูล</button>
         <a href="{{ url('admin_operate/setupoperatejob')  }}" class="btn btn-hero-sm btn-hero-danger" onclick="return confirm('ต้องการที่จะยกเลิกการแก้ไขข้อมูล ?')" >ยกเลิก</a> 
         </div>    
