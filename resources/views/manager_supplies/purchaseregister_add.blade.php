...
<center>    
    <div class="block" style="width: 95%;">
                ...
                <form  method="post" action="{{ route('msupplies.savepurchaseregister') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="col-sm-2">
                <input name="CON_NUM" id="CON_NUM" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" value="{{$maxnumberuse}}" required>
                </div>
        ...
        <input type="hidden" name="CON_YEAR_ID" id="CON_YEAR_ID" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" value="{{$yearbudget}}" required>       
        ...
        <div class="col-lg-2">        
        <input name="DATE_REGIS" id="DATE_REGIS" class="form-control input-lg datepicker" data-date-format="mm/dd/yyyy"  style=" font-family: 'Kanit', sans-serif;" value="{{formate(date('Y-m-d'))}}"  onchange="amountdate();" readonly>
        </div>
        ...
        <div class="col-lg-1">
        <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target=".addref" style="font-family: 'Kanit', sans-serif; font-size: 10px;font-size: 1.0rem;font-weight:normal;">เลือก</button>
        </div>  
        ...
        <div class="col-lg-4">
        <input name="DEP_REQUEST_BOOK" id="DEP_REQUEST_BOOK" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" value="" required>
        </div>
        ...
        <div class="col-lg-5">
                        <select name="DEP_REQUEST_ID" id="DEP_REQUEST_ID" class="form-control input-sm " style=" font-family: 'Kanit', sans-serif;" required>
        ...
        <div class="col-lg-4">        
        <select name="PERSON_REQUEST_ID" id="PERSON_REQUEST_ID" class="form-control input-sm " style=" font-family: 'Kanit', sans-serif;" required>
                    ...
                    <div class="col-lg-12">
                            ...
                            <div class="block block-rounded block-bordered">
                                <ul class="nav nav-tabs nav-tabs-info" data-toggle="tabs" role="tablist" style="background-color: #FFEBCD;">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="#object6" style="font-family: 'Kanit', sans-serif; font-size:12px;font-size: 1.0rem;font-weight:normal;">กรรมการตรวจรับ</a>
                                    </li>
                                    <li class="nav-item">
                    ...
                    <div class="block-content tab-content">
                                    ...
                                    <div class="tab-pane active" id="object1" role="tabpanel">
                                            ...
                                            <div class="row push">
                                                ...
                                                <div class="col-lg-10">
                                                <input name="ORG_ADD" id="ORG_ADD" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" value="{{$infosuppliespurchase->PURCHASE_GOV}}" required>
                                                </div>
                                            </div>
                                            <div class="row push">
                                                <div class="col-sm-2">
                                                ...
                                                <div class="col-lg-10">
                                                <input name="ORG_PROVINCE" id="ORG_PROVINCE" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" value="{{$infosuppliespurchase->PURCHASE_SUBROGATE}}" required>
                                                </div>
                                            </div>
                                            <div class="row push">
                                                <div class="col-sm-2">
                                            ...
                                            <div class="row push">
                                                ...
                                                <div class="col-lg-10">
                                                <input name="ORG_PROVINCE_LEADER" id="ORG_PROVINCE_LEADER" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" value="{{$infosuppliespurchase->PURCHASE_NOTIFY}}" required>
                                                </div>
                                            </div>
                                    </div>
                                    ...
                                    <div class="tab-pane" id="object2" role="tabpanel">
                                           ...
                                           <div class="row push">
                                                ...
                                                <select name="BUY_ID" id="BUY_ID" class="form-control input-sm " style=" font-family: 'Kanit', sans-serif;" required>
                                                ...
                                                <select name="CONDISION_ID" id="CONDISION_ID" class="form-control input-sm condition" style=" font-family: 'Kanit', sans-serif;" required>
                                            ...
                                            <div class="col-lg-10">        
                                            <textarea name="CONDISION_RESION" id="CONDISION_RESION" class="form-control reason" rows="2" id="comment" required></textarea>
                                            </div>
                                            ...
                                            <div class="row push">
                                                ...
                                                <select name="METHOD_ID" id="METHOD_ID" class="form-control input-sm " style=" font-family: 'Kanit', sans-serif;" required>
                                                ...
                                                <div class="col-lg-4">
                                                <select name="SUP_TYPE_ID" id="SUP_TYPE_ID" class="form-control input-sm " style=" font-family: 'Kanit', sans-serif;" required>
                                            ...
                                            <div class="col-lg-10">        
                                            <input name="CON_DETAIL" id="CON_DETAIL" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" value="" required>
                                            </div>
                                            ...
                                            <div class="row push">
                                                ...
                                                <select name="ASPECT_ID" id="ASPECT_ID" class="form-control input-sm " style=" font-family: 'Kanit', sans-serif;" required>
                                                ...
                                                <div class="col-lg-2">
                                                <input name="DATE_WANT_USE" id="DATE_WANT_USE" class="form-control input-lg datepicker" data-date-format="mm/dd/yyyy"  style=" font-family: 'Kanit', sans-serif;" onchange="amountdate();"  readonly required>
                                                </div>
                                                <div class="col-sm-1">
                                                <label>ประมาณ :</label>
                                                </div> 
                                                <div class="col-lg-1 amountdateuse">
                                                <input name="DATE_WANT_COUNT" id="" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" value="0">
                                                </div>
                                                <div class="col-lg-1">
                                                <label>วัน</label>
                                                </div>
                                            ...
                                            <div class="col-lg-10">        
                                            <textarea name="RESON_NAME" id="RESON_NAME" class="form-control" rows="2" id="comment" required></textarea>
                                            </div>
                                            ...
                                            <div class="row push">
                                                ...
                                                <select name="MONEY_GROUP_ID" id="MONEY_GROUP_ID" class="form-control input-sm " style=" font-family: 'Kanit', sans-serif;" required>
                                                ...
                                                <select name="BUDGET_ID" id="BUDGET_ID" class="form-control input-sm " style=" font-family: 'Kanit', sans-serif;" required>
                                    ...
                                    <div class="row push">
                                        ...
                                        <!--<div class="col-lg-2">
                                        <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target=".addbook" style="font-family: 'Kanit', sans-serif; font-size: 10px;font-size: 1.0rem;font-weight:normal;" >คำสั่งอ้างถึง</button>
                                        </div>--> 
                                        </div> 
                                    ...
                                    <div class="tab-pane" id="object5" role="tabpanel">
                                                ...
                                                <div class="row push"> 
                                                    ...
                                                    <select name="PURCHASE_LEADER_ID" id="PURCHASE_LEADER_ID" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" required>
                                                ...
                                                <div class="row push"> 
                                                    ...
                                                    <select name="PURCHASE_OFFICER_ID" id="PURCHASE_OFFICER_ID" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" required>
                                                ...
                                                <div class="row push"> 
                                                    ...
                                                    <select name="PURCHASE_HEAD_ID" id="PURCHASE_HEAD_ID" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" required>
                                    ...
                                    <!--<button type="button" class="btn btn-info btn-lg"  style="font-family: 'Kanit', sans-serif; font-size: 14px;font-weight:normal;" data-toggle="modal" data-target="#tream">เลือกคณะกรรมการ</button>
                                    ...
                                    <div class="modal-dialog modal-xl">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-info"  style="font-family: 'Kanit', sans-serif; font-size: 10px;font-size: 1.0rem;font-weight:normal;" data-dismiss="modal" onclick="saveaccessory();">บันทึกข้อมูล</button>
                                                <button type="button" class="btn btn-danger"  style="font-family: 'Kanit', sans-serif; font-size: 10px;font-size: 1.0rem;font-weight:normal;" data-dismiss="modal">ยกเลิก</button>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <?php $checkref =  ManagersuppliesController::checkref($suppliesrequest->ID); ?>
                               ...
                               @if($checkref == 0)
                                    <tr>
                                        ...
                                        <td >
                                             <button type="button" class="btn btn-info btn-lg"  style="font-family: 'Kanit', sans-serif; font-size: 13px;font-weight:normal;"  onclick="selectrequest({{$suppliesrequest->ID}});">เลือก</button> 
                                            {{-- <button type="button" class="btn btn-info btn-lg"  style="font-family: 'Kanit', sans-serif; font-size: 10px;font-size: 1.0rem;font-weight:normal;" >เลือก</button> --}}
                                        </td>
                                    </tr>
                                @endif
