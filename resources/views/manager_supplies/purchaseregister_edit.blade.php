...
<center>    
    <div class="block" style="width: 95%;">
                ...
                <form  method="post" action="{{ route('msupplies.updatepurchaseregister') }}" enctype="multipart/form-data">
        @csrf
       ...
       @endif
        ...
        <div class="col-lg-4">
        <input name="DEP_REQUEST_BOOK" id="DEP_REQUEST_BOOK" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" value="{{$infouppliesco->DEP_REQUEST_BOOK_NUM}}" required>
        </div>
                    ...
                    <div class="block-content tab-content">
                                    ...
                                    <div class="tab-pane active" id="object1" role="tabpanel">
                                            ...
                                            <div class="row push">
                                                ...
                                                <div class="col-lg-10">
                                                <input name="ORG_ADD" id="ORG_ADD" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" value="{{$infouppliesco->ORG_ADD}}" required>
                                                </div>
                                            </div>
                                            <div class="row push">
                                                <div class="col-sm-2">
                                                ...
                                                <div class="col-lg-10">
                                                <input name="ORG_PROVINCE" id="ORG_PROVINCE" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" value="{{$infouppliesco->ORG_PROVINCE}}" required>
                                                </div>
                                            </div>
                                            <div class="row push">
                                                <div class="col-sm-2">
                                            ...
                                            <div class="row push">
                                                ...
                                                <div class="col-lg-10">
                                                <input name="ORG_PROVINCE_LEADER" id="ORG_PROVINCE_LEADER" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" value="{{$infouppliesco->ORG_PROVINCE_LEADER}}" required>
                                                </div>
                                            </div>
                                    </div>
                                    ...
                                    <div class="tab-pane" id="object2" role="tabpanel">
                                           ...
                                           <div class="row push">
                                            ...
                                            <div class="col-lg-10">        
                                            <textarea name="CONDISION_RESION" id="CONDISION_RESION" class="form-control reason" rows="2" id="comment" required>{{$infouppliesco->CON_REASON}}</textarea>
                                            </div>
                                            ...
                                            <div class="col-lg-10">        
                                            <input name="CON_DETAIL" id="CON_DETAIL" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" value="{{$infouppliesco->CON_DETAIL}}" required>
                                            </div>
                                            ...
                                            <div class="col-lg-10">        
                                            <textarea name="RESON_NAME" id="RESON_NAME" class="form-control" rows="2" id="comment" required>{{$infouppliesco->RESON_NAME}}</textarea>
                                            </div>
                                    ...
                                    <div class="tab-pane" id="object5" role="tabpanel">
                                                ...
                                                <div class="row push"> 
                                                    ...
                                                    <option value="">--กรุณาเลือกชื่อเจ้าหน้าที่พัสดุ--</option>
                                                            @foreach ($infopersons as $infoperson)   
                                                            @if($infouppliesco->COMMIT_HR_ID == $infoperson ->ID )
                                                                    <option value="{{ $infoperson ->ID  }}" selected>{{ $infoperson-> HR_FNAME }} {{ $infoperson-> HR_LNAME }}</option> 
                                                                    @else
                                                                    <option value="{{ $infoperson ->ID  }}">{{ $infoperson-> HR_FNAME }} {{ $infoperson-> HR_LNAME }}</option> 
                                                                    @endif     
                                                ...
                                                <div class="row push"> 
                                                    ...
                                                    <option value="">--กรุณาเลือกชื่อหัวหน้าเจ้าหน้า--</option>
                                                            @foreach ($infopersons as $infoperson)   
                                ...
                                <thead style="background-color: #F0F8FF;">
                                        ...
                                        <tr height="40">
                                                ...
                                                <td style="text-align: center;"><a class="btn btn-danger remove" style="color:#FFFFFF;"><i class=" fa fa-trash-alt"></a></td>
                                            </tr>
                                            @endforeach 
        ...
        <div class="modal-footer">
            <div align="right">
                <button type="submit"  class="btn btn-info btn-lg" style="font-family: 'Kanit', sans-serif; font-size: 10px;font-size: 1.0rem;font-weight:normal;">บันทึกข้อมูล</button>
                    <a href="{{ url('manager_supplies/purchase')  }}" class="btn btn-danger btn-lg" onclick="return confirm('ต้องการที่จะยกเลิกการแก้ไขข้อมูล ?')" style="font-family: 'Kanit', sans-serif; font-size: 10px;font-size: 1.0rem;font-weight:normal;">ยกเลิก</a>
            </div>
        </div>
    </form>  
