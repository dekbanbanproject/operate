...
<body onload="run01();">
       ...
       <div class="col-sm-2">
            ...
            <div class="col-lg-2">
                <input name="DEP_SUB_SUB_PHONE" id="DEP_SUB_SUB_PHONE" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" value="{{$inforequest->DEP_SUB_SUB_PHONE}}" required>
            </div>
        </div>
       <div class="row push">
        <div class="col-sm-2">
