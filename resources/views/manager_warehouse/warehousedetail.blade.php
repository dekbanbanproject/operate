    ...
    <div class="block" style="width: 95%;">
        <div class="block block-rounded block-bordered">
            ...
            <div class="block-header block-header-default">
                ...
                <a href="{{ url('manager_warehouse/detail_excel/'.$year_id.'/'.$displaydate_bigen.'/'.$displaydate_end.'/'.$invenstatus_check0.'/'.$statuscheck0.'/'.$search0) }}"  class="btn btn-success btn-lg" style="font-family: 'Kanit', sans-serif; font-size: 13px;font-weight:normal;">EXCEL</a>
                </div>
            </div>
                ...
                <table class="table-striped table-vcenter js-dataTable-simple" style="width: 100%;">
                    ...
                    ?>
                     ...
                     <tr height="20">
                      ...
                      <td class="text-font text-pedding" >{{ManagerwarehouseController::supdetailname($infocheckreceive->RECEIVE_SUP_TYPE)}}</td>
                      @else
                      ...
                      @endif
                        ...
                        <button type="button" class="btn btn-outline-info dropdown-toggle" id="dropdown-align-outline-info" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="font-family: 'Kanit', sans-serif; font-size: 10px;font-weight:normal;">
                                ...
                                <a class="dropdown-item"  href="{{ url('manager_warehouse/warehouseinfocheckdetali/'.$infocheckreceive->RECEIVE_ID) }}"   style="font-family: 'Kanit', sans-serif; font-size: 13px;font-weight:normal;">รายละเอียด</a>
                                @if( $status == 2)
                                <a class="dropdown-item"  href="{{ url('manager_warehouse/warehouseinfochecksup/'.$infocheckreceive->RECEIVE_ID) }}"   style="font-family: 'Kanit', sans-serif; font-size: 13px;font-weight:normal;">ตรวจรับ</a>
                                @endif
                                @if( $status == 3)
                                <a class="dropdown-item"  href="{{url('manager_warehouse/detail_edit/'.$infocheckreceive->RECEIVE_ID)}}"   style="font-family: 'Kanit', sans-serif; font-size: 13px;font-weight:normal;">แก้ไขรายละเอียด</a>
                                <a class="dropdown-item"  href="{{ url('manager_warehouse/warehouseinfoconfirmdetali/'.$infocheckreceive->RECEIVE_ID) }}"   style="font-family: 'Kanit', sans-serif; font-size: 13px;font-weight:normal;">ยืนยันรับเข้าคลัง</a>
                                @endif
