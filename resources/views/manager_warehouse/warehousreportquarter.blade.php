...
<center>    
   ...
   <div class="block-content ">
            <form action="{{ route('mwarehouse.reportquartersearch') }}" method="post">
                @csrf
                <div class="row">
             ...
             <div class="table-responsive"> 
                ...
                <table class="table-striped table-vcenter " style="width: 100%;">
                    ...
                    <tr height="20">   
                        ...
                        <td class="text-font text-pedding" style="border: 1px solid black;" align="right">{{number_format(0,2)}}</td>
                        ...
                        <td class="text-font text-pedding" style="border: 1px solid black;" align="right">{{number_format($infotrialltotal_1-$infotrialltotalpay_1,2)}}</td>
                    ...
                    <tr height="20">   
                        ...
                        <td class="text-font text-pedding" style="border: 1px solid black;" align="right">{{number_format($infotricountytotal_1 - $infotricountytotalpay_1,2)}}</td>       
                    </tr> 
                    ...
                    <tr height="20">   
                        ...
                        <td class="text-font text-pedding" style="border: 1px solid black;" align="right">{{number_format($infotriprovincetotal_1 - $infotriprovincetotalpay_1,2)}}</td>
                    </tr> 
                    ...
                    <tr height="20">   
                        ...
                        <td class="text-font text-pedding" style="border: 1px solid black;" align="right">{{number_format($infotriselftotal_1-$infotriselftotalpay_1,2)}}</td>  
                    </tr> 
                    ...
                    <tr height="20">   
                        ...
                        <td class="text-font text-pedding" style="border: 1px solid black;" align="right">{{number_format($infonotremarktotal_1-$infonotremarktotalpay_1,2)}}</td>
                    </tr> 
                    ...
                    <tr height="20">   
                        ...
                        <td class="text-font text-pedding" style="border: 1px solid black;" align="right">{{number_format($infotribonustotal_1 - $infotribonustotalpay_1,2)}}</td>
                    </tr> 
                    </tbody>
                </table>
                ...
                <table class="table-striped table-vcenter " style="width: 100%;">
                    ...
                    <tbody>     
                        ...
                        <tr height="20">   
                            ...
                            <td class="text-font text-pedding" style="border: 1px solid black;" align="right">{{number_format(($infotrialltotal_1-$infotrialltotalpay_1+$infotrialltotal_2)-$infotrialltotalpay_2,2)}}</td>
                        ...
                        <tr height="20">   
                            ...
                            <td class="text-font text-pedding" style="border: 1px solid black;" align="right">{{number_format(($infotricountytotal_1 - $infotricountytotalpay_1+$infotricountytotal_2) - $infotricountytotalpay_2,2)}}</td>       
                        </tr> 
                        ...
                        <tr height="20">   
                            ...
                            <td class="text-font text-pedding" style="border: 1px solid black;" align="right">{{number_format(($infotriprovincetotal_1 - $infotriprovincetotalpay_1+$infotriprovincetotal_2) - $infotriprovincetotalpay_2,2)}}</td>
                        </tr> 
                        ...
                        <tr height="20">   
                            ...
                            <td class="text-font text-pedding" style="border: 1px solid black;" align="right">{{number_format(($infotriselftotal_1-$infotriselftotalpay_1+$infotriselftotal_2)-$infotriselftotalpay_2,2)}}</td>  
                        </tr> 
                        ...
                        <tr height="20">   
                            ...
                            <td class="text-font text-pedding" style="border: 1px solid black;" align="right">{{number_format(($infonotremarktotal_1-$infonotremarktotalpay_1+$infonotremarktotal_2)-$infonotremarktotalpay_2,2)}}</td>
                        </tr> 
                        ...
                        <tr height="20">   
                            ...
                            <td class="text-font text-pedding" style="border: 1px solid black;" align="right">{{number_format(($infotribonustotal_1 - $infotribonustotalpay_1+$infotribonustotal_2) - $infotribonustotalpay_2,2)}}</td>
                        </tr> 
                        </tbody>
                    </table>
                ...
                <table class="table-striped table-vcenter " style="width: 100%;">
                    ...
                    <tbody>     
                        ...
                        <tr height="20">   
                            ...
                            <td class="text-font text-pedding" style="border: 1px solid black;" align="right">{{number_format(((($infotrialltotal_1-$infotrialltotalpay_1+$infotrialltotal_2)-$infotrialltotalpay_2)+$infotrialltotal_3)-$infotrialltotalpay_3,2)}}</td>
                        ...
                        <tr height="20">   
                            ...
                            <td class="text-font text-pedding" style="border: 1px solid black;" align="right">{{number_format(((($infotricountytotal_1 - $infotricountytotalpay_1+$infotricountytotal_2) - $infotricountytotalpay_2)+$infotricountytotal_3)-$infotricountytotalpay_3,2)}}</td>       
                        </tr> 
                        ...
                        <tr height="20">   
                            ...
                            <td class="text-font text-pedding" style="border: 1px solid black;" align="right">{{number_format(((($infotriprovincetotal_1 - $infotriprovincetotalpay_1+$infotriprovincetotal_2) - $infotriprovincetotalpay_2)+$infotriprovincetotal_3)-$infotriprovincetotalpay_3,2)}}</td>
                        </tr> 
                        ...
                        <tr height="20">   
                            ...
                            <td class="text-font text-pedding" style="border: 1px solid black;" align="right">{{number_format(((($infotriselftotal_1-$infotriselftotalpay_1+$infotriselftotal_2)-$infotriselftotalpay_2)+$infotriselftotal_3)-$infotriselftotalpay_3,2)}}</td>  
                        </tr> 
                        ...
                        <tr height="20">   
                            ...
                            <td class="text-font text-pedding" style="border: 1px solid black;" align="right">{{number_format(((($infonotremarktotal_1-$infonotremarktotalpay_1+$infonotremarktotal_2)-$infonotremarktotalpay_2)+$infonotremarktotal_3)-$infonotremarktotalpay_3,2)}}</td>
                        </tr> 
                        ...
                        <tr height="20">   
                            ...
                            <td class="text-font text-pedding" style="border: 1px solid black;" align="right">{{number_format(((($infotribonustotal_1 - $infotribonustotalpay_1+$infotribonustotal_2) - $infotribonustotalpay_2)+$infotribonustotal_3)-$infotribonustotalpay_3,2)}}</td>
                        </tr> 
                        </tbody>
                    </table>
                ...
                <table class="table-striped table-vcenter " style="width: 100%;">
                    ...
                    <tbody>     
                        ...
                        <tr height="20">   
                            ...
                            <td class="text-font text-pedding" style="border: 1px solid black;" align="right">{{number_format($infotrialltotal_3-$infotrialltotalpay_3,2)}}</td>
                            ...
                            <td class="text-font text-pedding" style="border: 1px solid black;" align="right">{{number_format(($infotrialltotal_3-$infotrialltotalpay_3+$infotrialltotal_4)-$infotrialltotalpay_4,2)}}</td>
                        ...
                        <tr height="20">   
                            ...
                            <td class="text-font text-pedding" style="border: 1px solid black;" align="right">{{number_format($infotricountytotal_3 - $infotricountytotalpay_3,2)}}</td>
                            ...
                            <td class="text-font text-pedding" style="border: 1px solid black;" align="right">{{number_format(($infotricountytotal_3 - $infotricountytotalpay_3+$infotricountytotal_4) - $infotricountytotalpay_4,2)}}</td>       
                        </tr> 
    
                        <tr height="20">   
                            <td class="text-font text-pedding" style="border: 1px solid black;">ราคาสืบจังหวัด</td>
                            <td class="text-font text-pedding" style="border: 1px solid black;" align="center">{{$infotriprovince_4}}</td>
                            <td class="text-font text-pedding" style="border: 1px solid black;" align="right">{{number_format($infotriprovincetotal_3 - $infotriprovincetotalpay_3,2)}}</td>
                            ...
                            <td class="text-font text-pedding" style="border: 1px solid black;" align="right">{{number_format(($infotriprovincetotal_3 - $infotriprovincetotalpay_3+$infotriprovincetotal_4) - $infotriprovincetotalpay_4,2)}}</td>
                        </tr> 
    
                        <tr height="20">   
                            <td class="text-font text-pedding" style="border: 1px solid black;">ราคาจัดซื้อเอง</td>
                            <td class="text-font text-pedding" style="border: 1px solid black;" align="center">{{$infotriself_4}}</td>
                            <td class="text-font text-pedding" style="border: 1px solid black;" align="right">{{number_format($infotriselftotal_3-$infotriselftotalpay_3,2)}}</td>
                            ...
                            <td class="text-font text-pedding" style="border: 1px solid black;" align="right">{{number_format(($infotriselftotal_3-$infotriselftotalpay_3+$infotriselftotal_4)-$infotriselftotalpay_4,2)}}</td>  
                        </tr> 
                        ...
                        <tr height="20">   
                            ...
                            <td class="text-font text-pedding" style="border: 1px solid black;" align="right">{{number_format($infonotremarktotal_3-$infonotremarktotalpay_3,2)}}</td>
                            ...
                            <td class="text-font text-pedding" style="border: 1px solid black;" align="right">{{number_format(($infonotremarktotal_3-$infonotremarktotalpay_3+$infonotremarktotal_4)-$infonotremarktotalpay_4,2)}}</td>
                        </tr> 
    
                        <tr height="20">   
                            <td class="text-font text-pedding" style="border: 1px solid black;">ของแถม</td>
                            <td class="text-font text-pedding" style="border: 1px solid black;" align="center">{{$infotribonus_4}}</td>
                            <td class="text-font text-pedding" style="border: 1px solid black;" align="right">{{number_format($infotribonustotal_3 - $infotribonustotalpay_3,2)}}</td>
                            ...
                            <td class="text-font text-pedding" style="border: 1px solid black;" align="right">{{number_format(($infotribonustotal_3 - $infotribonustotalpay_3+$infotribonustotal_4) - $infotribonustotalpay_4,2)}}</td>
                        </tr> 
                        </tbody>
                    </table>
