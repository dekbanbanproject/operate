...
<div id="edit_modal{{ $operateswap->OPSWAP_ID}}" class="modal fade">
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-header">
        ...
        <div class="col-sm-9">
            <select name = "OPSWAP_DEP"  id="OPSWAP_DEP"  class="form-control input-lg">
        ...
        <div class="col-sm-9">
            <select name = "OPSWAP_PERSON_1"  id="OPSWAP_PERSON_1"  class="form-control input-lg">
        ...
        <div class="col-sm-9">
            <select name = "OPSWAP_PERSON_2"  id="OPSWAP_PERSON_2"  class="form-control input-lg">
        ...
        <div class="col-sm-9">
            <select name = "OPSWAP_JOB_1"  id="OPSWAP_JOB_1"  class="form-control input-lg">
                <option value=" " >--เลือกผู้รับเปลี่ยนเวร--</option>
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select name = "OPSWAP_JOB_2"  id="OPSWAP_JOB_2"  class="form-control input-lg">
                            <option value=" " >--เลือกผู้รับเปลี่ยนเวร--</option>
                            @foreach ($infojobs as $infojob)
