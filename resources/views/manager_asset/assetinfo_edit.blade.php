...
<div class="row">
   ...
   <div class="col-md-9">
        ...
        <div class="row">
            ...
            <div class="col-md-4" >
            <input name="ARTICLE_NUM" id="ARTICLE_NUM" class="form-control input-sm {{$errors->has('ARTICLE_NUM') ? 'is-invalid' : '' }}" style=" font-family: 'Kanit', sans-serif;" value="{{$infoasset->ARTICLE_NUM}}" required>
            ...
            <div class="col-md-4" >
            <input name="YEAR_ID" id="YEAR_ID" class="form-control input-sm {{$errors->has('YEAR_ID') ? 'is-invalid' : '' }}" style=" font-family: 'Kanit', sans-serif;" value="{{$infoasset->YEAR_ID}}" required>         
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4" >
            <input  name = "ARTICLE_PROP"  id="ARTICLE_PROP" class="form-control input-sm {{$errors->has('ARTICLE_PROP') ? 'is-invalid' : '' }}" style=" font-family: 'Kanit', sans-serif;" value="{{$infoasset->ARTICLE_PROP}}">
            </div>
        ...
        <div class="row">
            ...
            <select name="UNIT_ID" id="UNIT_ID" class="form-control input-lg js-example-basic-single {{$errors->has('UNIT_ID') ? 'is-invalid' : '' }}" style=" font-family: 'Kanit', sans-serif;" required>
        ...
        <div class="col">
            ...
            <select name="BRAND_ID" id="BRAND_ID" class="form-control input-lg js-example-basic-single {{$errors->has('BRAND_ID') ? 'is-invalid' : '' }}" style=" font-family: 'Kanit', sans-serif;" >
            ...
            <select name="COLOR_ID" id="COLOR_ID" class="form-control input-lg js-example-basic-single" style=" font-family: 'Kanit', sans-serif;" >
        ...
        <div class="col">
            ...
            <select name="MODEL_ID" id="MODEL_ID" class="form-control input-lg js-example-basic-single" style=" font-family: 'Kanit', sans-serif;" >
            ...
            <select name="SIZE_ID" id="SIZE_ID" class="form-control input-lg js-example-basic-single" style=" font-family: 'Kanit', sans-serif;" >
        ...
        <div class="row">
            ...
            <div class="col-md-4" >
            <input name="PRICE_PER_UNIT" id="PRICE_PER_UNIT" class="form-control input-lg {{$errors->has('PRICE_PER_UNIT') ? 'is-invalid' : '' }}" style=" font-family: 'Kanit', sans-serif;" value="{{$infoasset->PRICE_PER_UNIT}}" required>
            </div>
            <div class="col">
            <p style="text-align: left">วันที่รับเข้า</p>
            </div>
            <div class="col-md-4" >
            <input name="RECEIVE_DATE" id="RECEIVE_DATE" class="form-control input-lg datepicker {{$errors->has('RECEIVE_DATE') ? 'is-invalid' : '' }}" style=" font-family: 'Kanit', sans-serif;" data-date-format="mm/dd/yyyy" value="{{formate($infoasset->RECEIVE_DATE)}}" readonly required>
            </div>
        ...
        <div class="row">
            ...
            <select name="METHOD_ID" id="METHOD_ID" class="form-control input-lg js-example-basic-single {{$errors->has('METHOD_ID') ? 'is-invalid' : '' }}" style=" font-family: 'Kanit', sans-serif;" required>
            ...
            <select name="BUY_ID" id="BUY_ID" class="form-control input-lg js-example-basic-single {{$errors->has('BUY_ID') ? 'is-invalid' : '' }}" style=" font-family: 'Kanit', sans-serif;" required>
        ...
        <div class="row">
            ...
            <select name="BUDGET_ID" id="BUDGET_ID" class="form-control input-lg js-example-basic-single {{$errors->has('BUDGET_ID') ? 'is-invalid' : '' }}" style=" font-family: 'Kanit', sans-serif;" required>
            ...
            <select name="TYPE_ID" id="TYPE_ID" class="form-control input-lg js-example-basic-single {{$errors->has('TYPE_ID') ? 'is-invalid' : '' }}" style=" font-family: 'Kanit', sans-serif;" required>
        ...
        <div class="row">
            ...
            <select name="DECLINE_ID" id="DECLINE_ID" class="form-control input-lg js-example-basic-single {{$errors->has('DECLINE_ID') ? 'is-invalid' : '' }}" style=" font-family: 'Kanit', sans-serif;" required>
        ...
        <div class="row">
            ...
            <select name="DEP_ID" id="DEP_ID" class="form-control input-lg js-example-basic-single {{$errors->has('DEP_ID') ? 'is-invalid' : '' }}" style=" font-family: 'Kanit', sans-serif;" required>
            ...
            <select name="LOCATION_ID" id="LOCATION_ID" class="form-control input-lg location js-example-basic-single {{$errors->has('LOCATION_ID') ? 'is-invalid' : '' }}" style=" font-family: 'Kanit', sans-serif;" >
        ...
        <div class="row">
            ...
            <select name="LOCATION_LEVEL_ID" id="LOCATION_LEVEL_ID" class="form-control input-lg locationlevel js-example-basic-single {{$errors->has('LOCATION_LEVEL_ID') ? 'is-invalid' : '' }}" style=" font-family: 'Kanit', sans-serif;" >
            ...
            <select name="LEVEL_ROOM_ID" id="LEVEL_ROOM_ID" class="form-control input-lg locationlevelroom js-example-basic-single {{$errors->has('LEVEL_ROOM_ID') ? 'is-invalid' : '' }}" style=" font-family: 'Kanit', sans-serif;" >
        ...
        <div class="row">
            ...
            <select name="PERSON_ID" id="PERSON_ID" class="form-control input-lg js-example-basic-single {{$errors->has('PERSON_ID') ? 'is-invalid' : '' }}" style=" font-family: 'Kanit', sans-serif;" required>
        ...
        <div class="row">
            ...
            <div class="col-md-4" >
            <input name="EXPIRE_DATE" id="EXPIRE_DATE" class="form-control input-lg datepicker {{$errors->has('EXPIRE_DATE') ? 'is-invalid' : '' }}" style=" font-family: 'Kanit', sans-serif;" data-date-format="mm/dd/yyyy" value="{{formate($infoasset->EXPIRE_DATE)}}" readonly>
            </div>
        ...
        <div class="row">
            ...
            <select name="PM_TYPE_ID" id="PM_TYPE_ID" class="form-control input-lg js-example-basic-single {{$errors->has('PM_TYPE_ID') ? 'is-invalid' : '' }}" style=" font-family: 'Kanit', sans-serif;" >
            ...
            <select name="CAL_TYPE_ID" id="CAL_TYPE_ID" class="form-control input-lg js-example-basic-single {{$errors->has('CAL_TYPE_ID') ? 'is-invalid' : '' }}" style=" font-family: 'Kanit', sans-serif;" >
                        <option value="" >--กรุณาเลือก--</option>
        ...
        <div class="row">
            ...
            <select name="RISK_TYPE_ID" id="RISK_TYPE_ID" class="form-control input-lg js-example-basic-single {{$errors->has('RISK_TYPE_ID') ? 'is-invalid' : '' }}" style=" font-family: 'Kanit', sans-serif;" >
