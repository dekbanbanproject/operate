            ...
            <header id="page-header">
                ...
                <div class="content-header"  >
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <i class="fa fa-1.5x fa-tv text-warning"></i>
                            <span class="text-white-50"></span><span class="text-white" style="font-weight: normal;font-family: 'Kanit', sans-serif;">ระบบซ่อมคอมพิวเตอร์</span>
                        </a>
                        <!-- END Logo -->
                        ...
                        <div id="main-navigation" class="d-none d-lg-block ">
                            ...
                            <ul class="nav-main nav-main-horizontal nav-main-hover ">
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('manager_repaircom/dashboard') ? ' active' : '' }}" href="{{ url('manager_repaircom/dashboard') }}">
                                ...
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('manager_repaircom/carcalendar/detail') ? ' active' : '' }}" href="{{ url('manager_repaircom/carcalendar/detail') }}">
                            ...
                            <li class="nav-main-item"> 
                                <a class="nav-main-link{{ request()->is('manager_repaircom/repaircominfo') ? ' active' : '' }}" href="{{ url('manager_repaircom/repaircominfo') }}">
                                        <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">ข้อมูลการแจ้งซ่อมคอมพิวเตอร์</span>
                    
                                    </a>
                                </li>
                                <li class="nav-main-item"> 
                                    <a class="nav-main-link{{ request()->is('manager_repaircom/repaircominfoasset') ? ' active' : '' }}" href="{{ url('manager_repaircom/repaircominfoasset') }}">
                                        <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">ทะเบียนครุภัณฑ์คอมพิวเตอร์</span>
