            ...
            <header id="page-header">
                ...
                <div class="content-header"  >
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <i class="fa fa-1.5x fa-utensils text-warning"></i>
                            <span class="text-white-50"></span><span class="text-white" style="font-weight: normal;font-family: 'Kanit', sans-serif;">งานบริการอาหาร</span>
                        </a>
                        <!-- END Logo -->
                        ...
                        <div id="main-navigation" class="d-none d-lg-block ">
                            ...
                            <ul class="nav-main nav-main-horizontal nav-main-hover ">
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('manager_food/dashboard_food') ? ' active' : '' }}" href="{{ url('manager_food/dashboard_food') }}">
                                ...
                                <li class="nav-main-item"> 
                                        <a class="nav-main-link{{ request()->is('manager_food/infofoodbilltotal') ? ' active' : '' }}" href="{{ url('manager_food/infofoodbilltotal') }}">
                                        <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">ข้อมูลจัดซื้อวัสดุบริโภค</span>
                    
                                    </a>
                                </li>
                                <li class="nav-main-item"> 
                                        <a class="nav-main-link{{ request()->is('manager_food/infofoodbill') ? ' active' : '' }}" href="{{ url('manager_food/infofoodbill') }}">
                                        <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">ข้อมูลจัดซื้อรายวัน</span>
                    
                                    </a>
                                </li>
  
                                <li class="nav-main-item"> 
                                        <a class="nav-main-link{{ request()->is('manager_food/infofoodmenu') ? ' active' : '' }}" href="{{ url('manager_food/infofoodmenu') }}">
                                        <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">รายการเมนูอาหาร</span>
                    
                                    </a>
                                </li>
                                <li class="nav-main-item"> 
                                        <a class="nav-main-link{{ request()->is('manager_food/infofood') ? ' active' : '' }}" href="{{ url('manager_food/infofood') }}">
                                        <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">ข้อมูลวัสดุบริโภค</span>
                    
                                    </a>
                                </li>
                                <!--  <li class="nav-main-item"> 
                                <a class="nav-main-link{{ request()->is('manager_food/infofoodboard') ? ' active' : '' }}" href="{{ url('manager_food/infofoodboard') }}">
                                        <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">กรรมการตรวจรับ</span>
                    
                                    </a>
                                </li>
                                
                              <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->is('manager_food/infofoodtype') ? ' active' : '' }}" href="{{ url('manager_food/infofoodtype') }}">
                                <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">กำหนดประเภทอาหาร</span>
                    
                                    </a>
                                </li>
                    
                                <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->is('manager_food/infofoodunit') ? ' active' : '' }}" href="{{ url('manager_food/infofoodunit') }}">
                                <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">กำหนดหน่วยปริมาณ</span>
