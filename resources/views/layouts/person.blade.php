                ...
                <div class="content-header"  >
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <i class="fa fa-1.5x fa-users text-warning"></i>
                            <span class="text-white-50"></span><span class="text-white" style="font-weight: normal;font-family: 'Kanit', sans-serif;">บุคลากร</span>
                        </a>
                        <!-- END Logo -->
                        ...
                        <div id="main-navigation" class="d-none d-lg-block ">
                            ...
                            <ul class="nav-main nav-main-horizontal nav-main-hover ">
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('manager_person/dashboard') ? ' active' : '' }}" href="{{ url('manager_person/dashboard') }}">
                                ...
                                <li class="nav-main-item"> 
                                <a class="nav-main-link{{ request()->is('manager_person/carcalendar') ? ' active' : '' }}" href="{{ url('manager_person/carcalendar') }}">
                                        <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">ปฏิทิน</span>
                    
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('manager_person/inforperson') ? ' active' : '' }}" href="{{ url('manager_person/inforperson') }}">
                                        <i class="nav-main-link-icon fa fa-users"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">ข้อมูลบุคลากร</span>
                                ...
                                <li class="nav-main-item">
                                    ...
                                    <a class="nav-main-link{{ request()->is('manager_person/persondevreport') ? ' active' : '' }}" href="{{ url('manager_person/persondevreport') }}">
                                        <i class="nav-main-link-icon fa fa-users"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">ประชุมอบรมภายนอก</span>
                    
                                    </a> 
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('manager_person/inforperson_meetinginside') ? ' active' : '' }}" href="{{ url('manager_person/inforperson_meetinginside') }}">
                                        <i class="nav-main-link-icon fa fa-users"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">ประชุมอบรมภายใน</span>
                               ...
                               <!--   <li class="nav-main-item">
                                    ...
                                    <ul class="nav-main-submenu">
                                        ...
                                        <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{ url('manager_person/setinforperson_meetinginside') }}">
                                                <span class="nav-main-link-name"> ประเภทการประชุม</span>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
