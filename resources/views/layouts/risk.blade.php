...
{{-- 
                             ...
                             <li class="nav-main-item">
                                <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
                                    ...
                                    <span class="nav-main-link-name">รายงานหน่วยรับตรวจ</span>
                                </a>
                                ...
                                <li class="nav-main-item">
                                    ...
                                    <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{ url('manager_risk/risktime') }}">
                                                <span class="nav-main-link-name">ช่วงเวลา</span>
                                            </a>
                                        </li>
                                        <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{ url('manager_risk/risklocation') }}">
                                                <span class="nav-main-link-name">ชนิดสถานที่</span>
                                            </a>
                                        </li> 
                                          <li class="nav-main-item">
                                          ...
                                          <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{ url('manager_risk/riskgroupsub') }}">
                                                <span class="nav-main-link-name">หมวดอุบัติการณ์ความเสี่ยง</span>
                                            </a>
                                        </li> 
                                          <li class="nav-main-item">
                                        ...
                                        <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{ url('manager_risk/riskrepdetail') }}">
                                                <span class="nav-main-link-name">ประเภทอุบัติการณ์ความเสี่ยงย่อย</span>
                                            </a>
                                        </li> 
                                        <li class="nav-main-item">
                                        ...
                                        <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{ url('manager_risk/riskrepitemsub') }}">
                                                <span class="nav-main-link-name">อุบัติการณ์ความเสี่ยงย่อย</span>
                                            </a>
                                        </li> 
                                        <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{ url('manager_risk/riskrepprogram') }}">
                                                <span class="nav-main-link-name">ลักษณะอุบัติการณ์</span>
                                            </a>
                                        </li> 
                                        <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{ url('manager_risk/riskrepprogramsub') }}">
                                                <span class="nav-main-link-name">รายละเอียดย่อย 1</span>
                                            </a>
                                        </li> 
                                        <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{ url('manager_risk/riskrepprogramsubsub') }}">
                                                <span class="nav-main-link-name">รายละเอียดย่อย 2</span>
                                            </a>
                                        </li> 
                                        <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{ url('manager_risk/riskrep_typereason') }}">
                                                <span class="nav-main-link-name">สาเหตุที่ชัดแจ้ง</span>
                                            </a>
                                        </li> 
                                        <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{ url('manager_risk/riskrep_typereason_sys') }}">
                                                <span class="nav-main-link-name">สาเหตุเชิงระบบ</span>
                                            </a>
                                        </li> 
                                        <li class="nav-main-item">
                                        ...
                                        <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{ url('manager_risk/riskrep_function') }}">
                                                <span class="nav-main-link-name">ฟังชั่นการทำงาน</span>
                                            </a>
                                        </li> 
