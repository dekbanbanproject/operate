...
<html lang="en">
    ...
    <body>
        ...
        <div id="page-container" class="page-header-dark main-content-boxed page-header-fixed">
            ...
            <!-- Header -->
            <header id="page-header" style="background-color: #009900;">
                <!-- Header Content -->
                <div class="content-header"  >
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <i class="fa fa-1.5x fa-notes-medical text-warning"></i>
                            <span class="text-white-50"></span><span class="text-white" style="font-weight: normal;font-family: 'Kanit', sans-serif;">ยาและเวชภัณฑ์</span>
                        </a>
                        <!-- END Logo -->
            ...
            <main id="main-container">
                        ...
                        <div id="main-navigation" class="d-none d-lg-block ">
                            ...
                            <ul class="nav-main nav-main-horizontal nav-main-hover ">
                               <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('manager_medical/dashboard') ? ' active' : '' }}" href="{{ url('manager_medical/dashboard') }}">
                                ...
                                <li class="nav-main-item"> 
                                    <a class="nav-main-link{{ request()->is('manager_medical/reportInventory') ? ' active' : '' }}" href="{{ url('manager_medical/reportInventory') }}">
                                    <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                    <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">วัสดุคงคลัง</span>
                
                                </a>
                            </li>
                                <li class="nav-main-item"> 
                                        <a class="nav-main-link{{ request()->is('manager_medical/requestforbuy') ? ' active' : '' }}" href="{{ url('manager_medical/requestforbuy') }}">
                                        <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">ขอซื้อยาและเวชภัณฑ์</span>
                ...
                <!-- 19.5.63 -->
                                <li class="nav-main-item"> 
                                        <a class="nav-main-link{{ request()->is('manager_medical/detail') ? ' active' : '' }}" href="{{ url('manager_medical/detail') }}">
                                        <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">ตรวจรับ</span>
                    
                                    </a>
                                </li>
                                <li class="nav-main-item">  
                                    @if(request()->is('manager_medical/storehouse') || request()->is('manager_medical/medical_withdrawal/*'))
                                        <a class="nav-main-link active" href="{{ url('manager_medical/storehouse') }}">
                                    @else
                                    <a class="nav-main-link" href="{{ url('manager_medical/storehouse') }}">
                                    @endif   
                                            <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">สินค้าในคลังหลัก</span>
                                       
                                    </a>

                                </li>
                                <li class="nav-main-item"> 
                                        <a class="nav-main-link{{ request()->is('manager_medical/treasury') ? ' active' : '' }}" href="{{ url('manager_medical/treasury') }}">
                                        <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">คลังย่อย</span>
                    
                                    </a>   
                                </li>
                                <li class="nav-main-item"> 
                                <a class="nav-main-link{{ request()->is('manager_medical/disburse') ? ' active' : '' }}" href="{{ url('manager_medical/disburse') }}">
                                        <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">เบิกจ่ายยา</span>
                                ...
                                <a class="nav-main-link{{ request()->is('manager_medical/suppliesinfo') ? ' active' : '' }}" href="{{ url('manager_medical/suppliesinfo') }}">
                                        <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">ข้อมูลยาและเวชภัณฑ์</span>
                             ...
                             <!--  <li class="nav-main-item"> 
                                ...
                                <li class="nav-main-item"> 
                                        <a class="nav-main-link{{ request()->is('') ? ' active' : '' }}" href="">
                                        <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">ตั้งค่าพื้นฐาน</span>
                ...
                <!-- 19.5.63 -->
                               ...
                               <!-- <li class="nav-main-item">
                                    <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
                                        ...
                                        <span class="nav-main-link-name">รายงานมูลค่ายาและเวชภัณฑ์</span>
                                    </a>
                                    <ul class="nav-main-submenu">
                                        <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{ url('manager_medical/reportvalue') }}">
                                                <span class="nav-main-link-name">สรุปงานยาและเวชภัณฑ์</span>
                                            </a>
                                        </li>
                                        <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{ url('manager_medical/reportvaluestore') }}">
                                                <span class="nav-main-link-name">สรุปงานยาและเวชภัณฑ์ตามประเภทสิ่งของ คลังหลัก</span>
                                            </a>
                                        </li>
                                        <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{ url('manager_medical/reportvaluetreasury') }}">
                                                <span class="nav-main-link-name">สรุปงานยาและเวชภัณฑ์ตามประเภทสิ่งของ คลังย่อย</span>
                                            </a>
                                        </li>
