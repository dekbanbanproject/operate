            ...
            <header id="page-header">
                ...
                <div class="content-header"  >
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <i class="fa fa-1.5x fa-stethoscope text-warning"></i>
                            <span class="text-white-50"></span><span class="text-white" style="font-weight: normal;font-family: 'Kanit', sans-serif;">ระบบซ่อมเครื่องมือแพทย์</span>
                        </a>
                        <!-- END Logo -->
                        ...
                        <div id="main-navigation" class="d-none d-lg-block ">
                            ...
                            <ul class="nav-main nav-main-horizontal nav-main-hover ">
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('manager_repairmedical/dashboard') ? ' active' : '' }}" href="{{ url('manager_repairmedical/dashboard') }}">
                                ...
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('manager_repairmedical/carcalendar/detail') ? ' active' : '' }}" href="{{ url('manager_repairmedical/carcalendar/detail') }}">
                            ...
                            <li class="nav-main-item"> 
                                <a class="nav-main-link{{ request()->is('manager_repairmedical/repairmedicalinfo') ? ' active' : '' }}" href="{{ route('mrepairmedical.repairmedicalinfo') }}">
                                        <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">ทะเบียนแจ้งซ่อมเครื่องมือแพทย์</span>
                    
                                    </a>
                                </li>
                                <li class="nav-main-item"> 
                                    <a class="nav-main-link{{ request()->is('manager_repairmedical/repairmedicalinfoasset') ? ' active' : '' }}" href="{{ url('manager_repairmedical/repairmedicalinfoasset') }}">
                                        <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">ทะเบียนครุภัณฑ์เครื่องมือแพทย์</span>
                        
                                    </a>
                                </li>
                                 <!--    <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('manager_car/carinfonomal') ? ' active' : '' }}" href="">
