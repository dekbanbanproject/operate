            ...
            <header id="page-header">
                ...
                <div class="content-header"  >
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <i class="fa fa-1.5x fa-headset text-warning"></i>
                            <span class="text-white-50"></span><span class="text-white" style="font-weight: normal;font-family: 'Kanit', sans-serif;">ทะเบียนผู้บริจาค</span>
                        </a>
                        <!-- END Logo -->
                        ...
                        <div id="main-navigation" class="d-none d-lg-block ">
                            ...
                            <ul class="nav-main nav-main-horizontal nav-main-hover ">
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('manager_crm/dashboard') ? ' active' : '' }}" href="{{ url('manager_crm/dashboard') }}">
                                ...
                                <li class="nav-main-item"> 
                                        <a class="nav-main-link{{ request()->is('manager_crm/persondonate') ? ' active' : '' }}" href="{{ url('manager_crm/persondonate') }}">
                                        <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">ทะเบียนผู้บริจาค</span>
                    
                                    </a>
                                </li>
                                <li class="nav-main-item"> 
                                        <a class="nav-main-link{{ request()->is('manager_crm/persondonate_list') ? ' active' : '' }}" href="{{ url('manager_crm/persondonate_list') }}">
                                        <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">รายการบริจาค</span>
                    
                                    </a>
                                </li>
                                 <!--  <li class="nav-main-item"> 
                                        <a class="nav-main-link{{ request()->is('manager_crm/donationwealth') ? ' active' : '' }}" href="{{ url('manager_crm/donationwealth') }}">
                                        <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">ประเภททรัพย์</span>
                    
                                    </a>
                                </li>
                                <li class="nav-main-item"> 
                                <a class="nav-main-link{{ request()->is('manager_crm/donationunit') ? ' active' : '' }}" href="{{ url('manager_crm/donationunit') }}">
                                        <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">ประเภทหน่วย</span>
                    
                                    </a>
                                </li>
                                
                                 <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->is('manager_crm/donationtopic') ? ' active' : '' }}" href="{{url('manager_crm/donationtopic')}}">
                                <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">หัวข้อการรับ</span>
                                ...
                                <li class="nav-main-item">
                                    ...
                                    <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{ url('manager_crm/donationwealth') }}">
                                                <span class="nav-main-link-name">ประเภททรัพย์</span>
                                            </a>
                                        </li>
                                        <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{ url('manager_crm/donationunit') }}">
                                                <span class="nav-main-link-name">ประเภทหน่วย</span>
                                            </a>
                                        </li>
                                        <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{ url('manager_crm/donationtopic') }}">
                                                <span class="nav-main-link-name">หัวข้อการรับ</span>
                                            </a>
                                        </li>
