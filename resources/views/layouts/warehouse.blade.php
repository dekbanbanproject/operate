                        ...
                        <div id="main-navigation" class="d-none d-lg-block ">
                            ...
                            <ul class="nav-main nav-main-horizontal nav-main-hover ">
                                ...
                                <li class="nav-main-item"> 
                                        ...
                                        <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">Stock card :: คลังหลัก</span>
                                ...
                                <li class="nav-main-item"> 
                                        ...
                                        <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">Stock card :: คลังย่อย</span>
                                ...
                                <li class="nav-main-item"> 
                                        ...
                                        <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">เบิกจ่ายวัสดุ</span>
                                ...
                                <li class="nav-main-item">
                                    <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
                                        ...
                                        <span class="nav-main-link-name">รายงานมูลค่าวัสดุ</span>
                                    </a>
                                    <ul class="nav-main-submenu">
                                        <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{ url('manager_warehouse/reportvalue') }}">
                                                <span class="nav-main-link-name">สรุปงานวัสดุคงคลัง คลังวัสดุ</span>
                                            </a>
                                        </li>
                                        <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{ url('manager_warehouse/reportvaluestore') }}">
                                                <span class="nav-main-link-name">สรุปงานวัสดุคงคลังตามประเภทสิ่งของ คลังหลัก</span>
                                            </a>
                                        </li>
                                        <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{ url('manager_warehouse/reportvaluetreasury') }}">
                                                <span class="nav-main-link-name">สรุปงานวัสดุคงคลังตามประเภทสิ่งของ คลังย่อย</span>
                                            </a>
                                        </li>
                                        <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{ url('manager_warehouse/reportquarter') }}">
                                                <span class="nav-main-link-name">รายงานไตรมาส</span>
                                            </a>
                                        </li>
