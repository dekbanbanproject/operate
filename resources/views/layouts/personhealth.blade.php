...
<html lang="en">
    ...
    <body>
        ...
        <div id="page-container" class="page-header-dark main-content-boxed page-header-fixed">
            ...
            <!-- Header -->
            <header id="page-header" style="background-color: #EF862E;">
                <!-- Header Content -->
                <div class="content-header"  > 
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <i class="fa fa-1.5x fa-child text-warning"></i>
                            <span class="text-white-50"></span><span class="text-white" style="font-weight: normal;font-family: 'Kanit', sans-serif;">สุขภาพบุคลากร</span>
                        </a>
                        <!-- END Logo -->
                    ...
                    <div >
                        ...
                        <div id="main-navigation" class="d-none d-lg-block ">
                            ...
                            <li class="nav-main-item"> 
                                <a class="nav-main-link{{ request()->is('manager_person/healthdashboard') ? ' active' : '' }}" href="{{ url('manager_person/healthdashboard') }}">
                                ...
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('manager_person/carcalendarhealth') ? ' active' : '' }}" href="{{ url('manager_person/carcalendarhealth') }}">
                                        <i class="nav-main-link-icon fa fa-users"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">ปฏิทินงาน</span>
                    
                                    </a> 
                                </li>

                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('manager_person/inforpersonhealth') ? ' active' : '' }}" href="{{ url('manager_person/inforpersonhealth') }}">
                                        <i class="nav-main-link-icon fa fa-chart-pie"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">ตรวจสุขภาพ</span>
                    
                                    </a>
                                </li>
                          
                                 <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('manager_person/carcalendar') ? ' active' : '' }}" href="">
                                        <i class="nav-main-link-icon fa fa-users"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">ทดสอบสมรรถภาพ</span>
                    
                                    </a> 
                                </li>

                                <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->is('manager_person/reportinforpersonhealth') ? ' active' : '' }}" href="{{ url('manager_person/reportinforpersonhealth') }}">
                                ...
                                <!--<li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('manager_person/resultability') ? ' active' : '' }}" href="{{ url('manager_person/resultability') }}">
                                        <i class="nav-main-link-icon fa fa-users"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">ผลการประเมิน</span>
                                ...
                                <li class="nav-main-item">
                                    <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
                                        ...
                                        <span class="nav-main-link-name">ตั้งค่าข้อมูล</span>
                                    </a>
