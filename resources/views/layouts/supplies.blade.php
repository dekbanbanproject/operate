                    ...
                    <div >
                        ...
                        <div id="main-navigation" class="d-none d-lg-block ">
                            ...
                            <ul class="nav-main nav-main-horizontal nav-main-hover" style="width: 95%;margin: auto;">
                               ...
                               <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('manager_supplies/setupfsn') ? ' active' : '' }}" href="{{ url('manager_supplies/setupfsn') }}">
                                        <i class="nav-main-link-icon fa fa-users"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">ตั้งค่า FSN</span>
