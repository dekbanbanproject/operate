            ...
            <header id="page-header">
                ...
                <div class="content-header"  >
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <i class="fa fa-1.5x fa-shield-alt text-warning"></i>
                            <span class="text-white-50"></span><span class="text-white" style="font-weight: normal;font-family: 'Kanit', sans-serif;">ระบบเจ้าหน้าที่รักษาความปลอดภัย</span>
                        </a>
                        <!-- END Logo -->
                        ...
                        <div id="main-navigation" class="d-none d-lg-block ">
                            ...
                            <ul class="nav-main nav-main-horizontal nav-main-hover ">
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('manager_safe/dashboard') ? ' active' : '' }}" href="{{ url('manager_safe/dashboard') }}">
                                ...
                                <li class="nav-main-item"> 
                                <a class="nav-main-link{{ request()->is('manager_safe/infosafe') ? ' active' : '' }}" href="{{ url('manager_safe/infosafe') }}">
                                        <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">เหตุการณ์ในเวร</span>
