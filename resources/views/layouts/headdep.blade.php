...
<html lang="en">
    ...
    <body>
        ...
        <div id="page-container" class="page-header-dark main-content-boxed page-header-fixed">
            ...
            <!-- Header -->
            <header id="page-header" style="background-color: #FF8C00;">
                <!-- Header Content -->
                <div class="content-header"  >
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <i class="fa fa-1.5x fa-book-open text-warning"></i>
                            <span class="text-white-50"></span><span class="text-white" style="font-weight: normal;">หัวหน้างาน</span>
                        </a>
                        <!-- END Logo -->
                        ...
                        <div id="main-navigation" class="d-none d-lg-block ">
                           ...
                           <ul class="nav-main nav-main-horizontal nav-main-hover ">
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('person_headdep/dashboard') ? ' active' : '' }}" href="{{ url('person_headdep/dashboard') }}">
                                        <i class="nav-main-link-icon fa fa-chart-pie"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;">Dashboard</span>
                    
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('person_headdep/headdep_book') ? ' active' : '' }}" href="{{ url('person_headdep/headdep_book') }}">
                                        <i class="nav-main-link-icon fa fa-book"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;">หนังสือราชการ</span>
                    
                                    </a> 
                                </li>
                                <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->is('person_headdep/headdep_leave') ? ' active' : '' }}" href="{{ url('person_headdep/headdep_leave') }}">
                                        <i class="nav-main-link-icon fa fa-paper-plane"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;">เห็นชอบการลา</span>
                    
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->is('person_headdep/headdep_persondev') ? ' active' : '' }}" href="{{ url('person_headdep/headdep_persondev') }}">
                                  
                                        <i class="nav-main-link-icon fa fa-handshake"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;">เห็นชอบประชุม/อบรม/ดูงาน</span>
                    
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->is('person_headdep/headdep_supplier') ? ' active' : '' }}" href="{{ url('person_headdep/headdep_supplier') }}">
                                        <i class="nav-main-link-icon fa fa-paper-plane"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;">เห็นชอบจัดซื้อจัดจ้าง</span>
                              ...
                              <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('person_headdep/headdep_warehouse') ? ' active' : '' }}" href="{{ url('person_headdep/headdep_warehouse') }}">
                                        {{-- <i class="nav-main-link-icon fa fa-clipboard-list"></i> --}}
                                        <i class="nav-main-link-icon fa fa-box-open text-secondary"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;">เห็นชอบคลังวัสดุ</span>
                            ...
                            {{--
                             <li class="nav-main-item">
                                    <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
                                        ...
                                        <span class="nav-main-link-name">แผนงาน</span>
                                    </a>                                    
                                    <ul class="nav-main-submenu">
                                        <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{ url('person_headdep/headdepplan_project') }}">
                                                <span class="nav-main-link-name">แผนงานโครงการ</span>
                                            </a>
                                        </li>
                                        <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{ url('person_headdep/headdepplan_humandev') }}">
                                                <span class="nav-main-link-name">แผนงานพัฒนาบุคลากร</span>
                                            </a>
                                        </li>
                                        <li class="nav-main-item">
                                            <a class="nav-main-link" href="{{ url('person_headdep/headdepplan_durable') }}">
