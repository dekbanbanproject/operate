...
?>
                ...
                <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;"><i class="fas fa-plus"></i> เพิ่มกำหนดค่าวันลาพักผ่อน</h2>    
     ...
     <label >{{$infoleaveover->OVER_YEAR_ID}}</label>
      ...
      <div class="row push">
       ...
       <div class="col-lg-2">
       <input  name = "OLDS"  id="OLDS" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{$infoleaveover->OLDS}}">
       </div>
       <div class="col-lg-1">
       <label >ปี</label>
       </div>
       ...
       <div class="col-lg-1">
       <input  name = "DAY_LEAVE_OVER_BEFORE"  id="DAY_LEAVE_OVER_BEFORE" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{ number_format($infoleaveover->DAY_LEAVE_OVER_BEFORE,1)}}">
       </div>
       <div class="col-lg-1">
       <label >วัน</label>
       </div>
