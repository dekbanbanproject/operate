...
<div>
    ...
    <div class="col-lg-6">
    <div class="form-group">
    <input  name = "ORG_ADDRESS"  id="ORG_ADDRESS"  class="form-control input-lg"  style=" font-family: 'Kanit', sans-serif; font-size: 13px;" value="{{ $infoorg->ORG_ADDRESS }}" onkeyup="check_org_address();">
