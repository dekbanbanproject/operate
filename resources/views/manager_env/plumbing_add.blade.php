                        ...
                        <table class="gwt-table table-striped table-vcenter" style="width: 100%;">
                            ...
                            <tbody class="tbody">
                                ...
                                <tr height="20"> 
                                    ...
                                    <td class="text-font"><input value="{{ $list_check->SETUP_PLUMBING_TESTER }}" name="PLUMBING_SUB_TESTER[]" id="PLUMBING_SUB_TESTER[]" class="form-control input-sm fo13" readonly></td>
