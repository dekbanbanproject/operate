...
<body onload="run01();">
                ...
                <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;"><i class="fas fa-plus"></i> เพิ่มข้อมูลขอใช้รถยนต์ทั่วไป</h2> 
                        
        <form  method="post" action="{{ route('addcar.carnomalsave') }}" enctype="multipart/form-data">
        @csrf
     <div class="row push">
        ...
        <input name="BOOK_NAME" id="BOOK_NAME" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" required>
        </div> 
        <div class="col-lg-2">
       ...
       <input type="hidden" name="CAR_REQUEST_ID" id="CAR_REQUEST_ID" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="">
       
        <div class="col-sm-2">
        <label>รถโรงพยาบาลทะเบียน :</label>
        </div> 
        <div class="col-lg-3">
        <input name="" id="" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" required>
        </div> 
        ...
        <div class="col-lg-4">
        <input name="" id="" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" readonly>
        </div> 
        ...
        <div class="col-lg-3">
        <input name="CAR_OWNER" id="CAR_OWNER" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" >
        </div> 
       ...
       <div class="row push">
        ...
        <div class="col-lg-10">
        <input name="RESERVE_NAME" id="RESERVE_NAME" class="form-control input-sm"  onkeyup="checkreservename()" required>
        ...
        <div class="col-lg-4">
        <select name="RESERVE_LOCATION_ID" id="RESERVE_LOCATION_ID" class="form-control input-lg js-example-basic-single org_re" style=" font-family: 'Kanit', sans-serif;" onchange="checkreservelocationid()" required>
        ...
        <div class="col-lg-2">
        <a class="btn btn-hero-sm btn-hero-info" style="font-family: 'Kanit', sans-serif; font-size: 10px;font-size: 1.0rem;font-weight:normal;color:#FFFFFF;" onclick="addorg();"> เพิ่ม</a>
        </div> 
       </div>
        ...
        <div class="col-lg-2">
        <input name="RESERVE_BEGIN_DATE" id="RESERVE_BEGIN_DATE" class="form-control input-sm datepicker" data-date-format="mm/dd/yyyy" onchange="checkreservebegindate()"  readonly required>
        ...
        <div class="col">
        <input type="text" class="js-masked-time form-control" id="RESERVE_BEGIN_TIME" name="RESERVE_BEGIN_TIME" style=" font-family: 'Kanit', sans-serif;" placeholder="00:00" onkeyup="checkreservebegintime()">
        ...
        <div class="col-lg-2">
        <input name="RESERVE_END_DATE" id="RESERVE_END_DATE" class="form-control input-sm datepicker" data-date-format="mm/dd/yyyy" onchange="checkreserveenddate()" readonly required>
        ...
        <input type="text" class="js-masked-time form-control" id="RESERVE_END_TIME" name="RESERVE_END_TIME" style=" font-family: 'Kanit', sans-serif;" placeholder="00:00" onkeyup="checkreserveendtime()">
        ...
        <div class="col-lg-4">
        <select name="CAR_DRIVER_ID" id="CAR_DRIVER_ID" class="form-control input-lg js-example-basic-single" style=" font-family: 'Kanit', sans-serif;" required>
        ...
        <div class="col-lg-4">
        <select name="LEADER_PERSON_ID" id="LEADER_PERSON_ID" class="form-control input-lg js-example-basic-single" style=" font-family: 'Kanit', sans-serif;" required>
                                    ...
                                    <table class="table gwt-table" >
                                        <thead>
                                            <tr>
                                                ...
                                                <td style="text-align: center;" width="15%"><a  class="btn btn-hero-sm btn-hero-success addRow3" style="color:#FFFFFF;"><i class="fa fa-plus"></i>
                                                </a></td>
                                            </tr>
                                        </thead> 
                                        <tbody class="tbody3">   
        ...
        <a href="{{ url('general_car/gencartype/'.$inforpersonuserid -> ID)  }}" class="btn btn-hero-sm btn-hero-danger" onclick="return confirm('ต้องการที่จะยกเลิกการเพิ่มข้อมูล ?')" ><i class="fas fa-window-close mr-2"></i>ยกเลิก</a>
        </div>
