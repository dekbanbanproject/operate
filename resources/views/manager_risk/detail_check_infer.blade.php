        ...
        <div class="block mt-5" style="width: 95%;">
            <div class="block block-rounded block-bordered">
                ...
                <div class="block-content block-content-full">
                    <form method="post" action="{{ route('mrisk.detail_check_inferupdate') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row push text-left">
                            <div class="col-sm-2">
                                <label for="RISKREP_DETAILRISK2"
                                    style="font-family:'Kanit',sans-serif;font-size:13px;">ข้อเสนอแนะ/การดำเนินการร่วมแก้ไขปัญหา
                                    :</label>
                            </div>
                            <div class="col-lg-9 ">
                                <textarea name="RISKREP_DETAILRISK2" id="RISKREP_DETAILRISK2"
                                    class="form-control input-lg time fo13 mt-0"
                                    rows="2"> {{ $rigreps->RISKREP_DETAILRISK2 }} </textarea>
                            </div>
                        </div>
                        ...
                        <div class="row push text-left">
                            <div class="col-sm-2">
                                <label for=""
                                    style="font-family:'Kanit',sans-serif;font-size:15px;color:rgb(0,0,128);">สรุปผลการดำเนินงานแก้ไขปัญหา
                                    :</label>
                            </div>
                            <div class="col-lg-10">
                            </div>
                        ...
                        <div class="row push text-left">
                            <div class="col-sm-2">
                                <label for="RISKREP_INFER_EDIT" style="font-family:'Kanit',sans-serif;font-size:13px;">สรุปประเด็นการจัดการแก้ไข :</label>
                            </div>
                            <div class="col-lg-9">
                                <textarea name="RISKREP_INFER_EDIT" id="RISKREP_INFER_EDIT" class="form-control input-lg fo13 mt-0" rows="2">{{$rigreps->RISKREP_INFER_EDIT}} </textarea>
                            </div>                           
                        </div>
                        <div class="row push text-left">
                            <div class="col-sm-2">
                                <label for="RISKREP_INFER_GROUPPROBLEM" style="font-family:'Kanit',sans-serif;font-size:13px;">ปัญหาของกลุ่ม/หน่วยงานหลัก :</label>
                            </div>
                            <div class="col-lg-9">
                                <textarea name="RISKREP_INFER_GROUPPROBLEM" id="RISKREP_INFER_GROUPPROBLEM" class="form-control input-lg fo13 mt-0" rows="2"> {{$rigreps->RISKREP_INFER_GROUPPROBLEM}}</textarea>
                            </div>                           
                        </div>
                        <div class="row push text-left">
                            <div class="col-sm-2">
                                <label for="RISKREP_INFER_PERFORMANCE" style="font-family:'Kanit',sans-serif;font-size:13px;">ผลการดำเนินงาน :</label>
                            </div>
                            <div class="col-lg-9">
                                <textarea name="RISKREP_INFER_PERFORMANCE" id="RISKREP_INFER_PERFORMANCE" class="form-control input-lg fo13 mt-0" rows="2">{{$rigreps->RISKREP_INFER_PERFORMANCE}} </textarea>
                            </div>                           
                        </div>
                        <div class="row push text-left">
                            <div class="col-sm-2">
                                <label for="RISKREP_INFER_IMPROVE" style="font-family:'Kanit',sans-serif;font-size:13px;">ระบบงานที่มีการปรับปรุงพัฒนา :</label>
                            </div>
                            <div class="col-lg-9">
                                <textarea name="RISKREP_INFER_IMPROVE" id="RISKREP_INFER_IMPROVE" class="form-control input-lg fo13 mt-0" rows="2">{{$rigreps->RISKREP_INFER_IMPROVE}} </textarea>
                            </div>                           
                        </div>
                        <div class="row push text-left">
                            <div class="col-sm-2">
                                <label for="RISKREP_INFER_DAYENDPROBLEM" style="font-family:'Kanit',sans-serif;font-size:13px;">วันที่สิ้นสุดการแก้ไขปัญหา :</label>
                            </div>
                            <div class="col-lg-2">
                                @if ($rigreps->RISKREP_INFER_DAYENDPROBLEM == '')
                                <input name="RISKREP_INFER_DAYENDPROBLEM" id="RISKREP_INFER_DAYENDPROBLEM" class="form-control input-lg datepicker fo13" data-date-format="mm/dd/yyyy" value="{{formate($datenow)}}" readonly> 
                                @else
                                <input name="RISKREP_INFER_DAYENDPROBLEM" id="RISKREP_INFER_DAYENDPROBLEM" class="form-control input-lg datepicker fo13" data-date-format="mm/dd/yyyy" value="{{formate($rigreps->RISKREP_INFER_DAYENDPROBLEM)}}" readonly>  
                                @endif
                               
                            </div>  
                            <div class="col-sm-1">
                                <label for="RISKREP_INFER_USERSAVE" style="font-family:'Kanit',sans-serif;font-size:13px;">ผู้บันทึก :</label>
                            </div>
                            <div class="col-lg-3">
                                <input name="" id="" class="form-control input-lg fo13" value="{{$perinfos->HR_FNAME}}   {{$perinfos->HR_LNAME}}" readonly>  
                                <input type="hidden" name="RISKREP_INFER_USERSAVE" id="RISKREP_INFER_USERSAVE" class="form-control input-lg fo13" value="{{$id_user}}"> 
                            </div>  
                            <div class="col-sm-1"> 
                                <label for="RISKREP_INFER_DAYSAVE" style="font-family:'Kanit',sans-serif;font-size:13px;">วันที่บันทึก :</label>
                            </div>
                            <div class="col-lg-2">
                                @if ($rigreps->RISKREP_INFER_DAYSAVE == '')
                                <input name="RISKREP_INFER_DAYSAVE" id="RISKREP_INFER_DAYSAVE" class="form-control input-lg datepicker fo13" data-date-format="mm/dd/yyyy" value="{{formate($datenow)}}" readonly>  
                                @else
                                <input name="RISKREP_INFER_DAYSAVE" id="RISKREP_INFER_DAYSAVE" class="form-control input-lg datepicker fo13" data-date-format="mm/dd/yyyy" value="{{formate($rigreps->RISKREP_INFER_DAYSAVE)}}" readonly>  
                                @endif
                                        ...
                                        <div class="tab-pane" id="object8" role="tabpanel">
                                            <table class="table-striped table-vcenter js-dataTable-simple"
                                                ...
                                                <tbody class="tbody8">
                                                    ...
                                                    <tr>
                                                        @if ($rep_infoper->RISK_REP_PERSON_NAME !== '' && $rep_infoper->RISK_REP_PERSON_NAME !== null)
                                                            <td><input name="RISK_REP_PERSON_NAME[]" id="RISK_REP_PERSON_NAME" class="form-control input-sm fo13" value="{{$rep_infoper->RISK_REP_PERSON_NAME}}"></td>
                                                        @else
                                                            <td><input name="RISK_REP_PERSON_NAME[]" id="RISK_REP_PERSON_NAME" class="form-control input-sm fo13"></td>
                                                        @endif
                    ...
                    @section('footer')
                        ...
                        <script>
                            ...
                            function addRow8() {
                                ...
                                var tr = '<tr>' +
                                    '<td>' +
                                    '<input name="RISK_REP_PERSON_NAME[]" id="RISK_REP_PERSON_NAME" class="form-control input-sm fo13" >' +
                                    '</td>' +
                                    '<td style="text-align: center;"><a class="btn btn-hero-sm btn-hero-danger remove" style="color:#FFFFFF;"><i class="fa fa-trash-alt"></i></a></td>' +
                                    '</tr>';
                                $('.tbody8').append(tr);
