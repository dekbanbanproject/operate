                ...
                <table class="gwt-table table-striped table-vcenter js-dataTable-simple" style="width: 100%;">
                    <thead style="background-color: #e3ccf8;">
                        <tr height="40">
                            ...
                            <th class="text-font" style="text-align: center;" width="7%">รหัส</th>
                            <th class="text-font" style="text-align: center;" width="6%">สถานะ</th>
                            <th class="text-font" style="text-align: center;" width="8%">ความรุนแรง</th>
                            <th class="text-font" style="text-align: center;" >เรื่อง</th>
                            {{-- รายละเอียดเหตุการ --}}
                            <th class="text-font" style="text-align: center;" width="15%">กลุ่ม/หน่วยงานหลัก</th>
                            {{-- การจัดการเบื้องต้น --}}
                            <th class="text-font" style="text-align: center;" width="13%">กลุ่ม/หน่วยงานร่วม</th>
                            <th class="text-font" style="text-align: center;" width="10%">รายละเอียด</th>
                            ...
                            <td align="center" width="5%"  style="vertical-align: top;text-align: center;">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu fo13" style="width:10px"> 
                                            ...
                                            <a class="dropdown-item" href="{{ url('manager_risk/detail_edit/'.$rigrep->RISKREP_ID)}}">ทบทวนรายงาน</a>
                                            {{-- @endif                                           --}}
                                            {{-- @if ($rigrep -> RISKREP_STATUS == 'CHECK') --}}
                                            <a class="dropdown-item" href="{{ url('manager_risk/detail_check/'.$rigrep->RISKREP_ID)}}">ตรวจสอบ</a>
                                            {{-- @endif  --}}
