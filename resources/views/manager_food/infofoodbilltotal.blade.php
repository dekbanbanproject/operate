                    ...
                    ?>
                        ...
                        <tr height="20">
                            ...
                            <td class="text-font text-pedding">{{$inforequest->VENDOR_NAME}}</td>
                             ...
                             <td class="text-font text-pedding">{{$inforequest->BUDGET_NAME}} ssssssssssss</td>
                            ...
                            <td align="center" width="5%">
                                ...
                                <a class="dropdown-item" href="{{ url('manager_food/infofoodbilltotal_edit/'.$inforequest->ID)}}" style="font-family: 'Kanit', sans-serif; font-size: 15px;font-weight:normal;">แก้ไขทะเบียนคุม</a>
                                <a class="dropdown-item"  href="{{ url('manager_food/infofoodbilltotal_cancel/'.$inforequest->ID)}}"  style="font-family: 'Kanit', sans-serif; font-size: 15px;font-weight:normal;">ยกเลิกทะเบียนคุม</a>
                             -----------------------
                             @endif  
                                                ...
                                                <a class="dropdown-item" href="{{ url('manager_food/infofoodbilltotal_quotation_add/'.$inforequest->ID)  }}" style="font-family: 'Kanit', sans-serif; font-size: 15px;font-weight:normal;"><i class="fas fa-plus"></i> เพิ่มใบเสนอราคา</a>
                                             
                                                
                                                <a class="dropdown-item" href="{{ url('manager_food/purchaselist_add/'.$inforequest->ID)  }}" style="font-family: 'Kanit', sans-serif; font-size: 15px;font-weight:normal;"><i class="fas fa-plus"></i> เพิ่มรายการพัสดุ</a>
                                             
                                                <a class="dropdown-item" href="{{ url('manager_food/infofoodbilltotal_orders/'.$inforequest->ID)  }}" style="font-family: 'Kanit', sans-serif; font-size: 15px;font-weight:normal;">ออกใบสั่งซื้อ/สั่งจ้าง</a>

                                                @endif
                                                @if($inforequest->REGIS_STATUS_ID == 4 || $inforequest->REGIS_STATUS_ID == 5)
                                                <a class="dropdown-item" href="{{ url('manager_food/purchascheck/'.$inforequest->ID)  }}" style="font-family: 'Kanit', sans-serif; font-size: 15px;font-weight:normal;">@if($inforequest->REGIS_STATUS_ID == 5)แก้ไขตรวจรับ@elseตรวจรับ@endif</a>
                                                @endif
                                                @if($inforequest->REGIS_STATUS_ID == 5)
                                            
                                                <a class="dropdown-item"  href="{{ url('manager_food/purchasequotation_confirm/'.$inforequest->ID)  }}" style="font-family: 'Kanit', sans-serif; font-size: 15px;font-weight:normal;"  onclick="return confirm('ต้องการที่ยืนยันตรวจรับรายการ {{$inforequest->CON_NUM}} หรือไม่? ')">ยืนยันตรวจรับ</a>
                                                @endif
                                                @if($inforequest->REGIS_STATUS_ID == 7)
                                                <a class="dropdown-item" href="{{ url('manager_supplies/send_infomation/'.$inforequest->ID)  }}" style="font-family: 'Kanit', sans-serif; font-size: 15px;font-weight:normal;" onclick="return confirm('ต้องการที่ยืนยันส่งข้อมูลรายการ {{$inforequest->CON_NUM}} หรือไม่? ')">ส่งบัญชี/คลัง</a>
                                                @endif
                                                ...
                                                <a class="dropdown-item"  href="#detail_print"  data-toggle="modal"  style="font-family: 'Kanit', sans-serif; font-size: 15px;font-weight:normal;" onclick="print({{$inforequest->ID}});">พิมพ์เอกสาร</a>
                                </div>
                                </div>
                            </td> 
