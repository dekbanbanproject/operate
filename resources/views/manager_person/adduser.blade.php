                ...
                <div class="row push">
                        <div class="col-lg-4">
                                <div class="form-group">
                                        ...
                                        <img id="image_upload_preview" src="/storage/images/nopic.jpg;base64," alt="กรุณาเพิ่มรูปภาพ" height="200px" width="200px"/>
                        ...
                        <div class="col-lg-4">
                                ...
                                <div class="form-group">
                                        <div class="row">
                                                ...
                                                <div class="col-lg-6">        
                                                        <input name="HR_HIGH" id="HR_HIGH" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" OnKeyPress="return chkNumber(this)" onkeyup="checkhrhight()">
                                                </div>
                                                <div class="col-lg-3"> 
                                ...
                                <div class="form-group">
                                        <div class="row">
                                                ...
                                                <div class="col-lg-6"> 
                                                        <input name="HR_WEIGHT" id="HR_WEIGHT" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" OnKeyPress="return chkNumber(this)" onkeyup="checkhrweight()">
                                                </div>
                                                <div class="col-lg-3">      
                                ...
                                <div class="form-group">
                                        <div class="row">
                                                ...
                                                <div class="col-lg-9"> 
                                                        <input name="HR_PHONE" id="HR_PHONE" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" OnKeyPress="return chkNumber(this)" maxlength="10" onkeyup="checkhrphone()">
                                                </div>
                                ...
                                <div class="col-lg-4"> 
                                        ...
                                        <div class="form-group">
                                                <div class="row">
                                                        ...
                                                        <div class="col-lg-7">               
                                                                <select name="HR_KIND" id="HR_KIND" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onchange="checkhrkind()">
...
if(nusername==null || nusername=='' ||name==null || name=='' || nprefix==null || nprefix=='' || 
