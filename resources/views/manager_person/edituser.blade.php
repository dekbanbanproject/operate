...
<style>
        ...
        <center>
                ...
                <form method="post" action="{{ route('mperson.editinfouserupdate') }}"  enctype="multipart/form-data" class="needs-validation" novalidate>
            
                        @csrf
                     
                         
                        <input type="hidden" name = "USER_ID" id="USER_ID" class="form-control input-lg" value="{{ $infoid -> ID }}" >
                ...
                <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;"><span style="border-radius: 5px;font-size: 18px;">&nbsp;&nbsp;ข้อมูลส่วนตัว&nbsp;&nbsp;</span></h2>   
                        ...
                        <div class="row push">
                                <div class="col-lg-4">
                                        ...
                                        <img id="image_upload_preview" src="data:image/png;base64,{{ chunk_split(base64_encode($inforpersons->HR_IMAGE)) }}" height="200px" width="200px"> 
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="col-lg-4">
                                        <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9">
                                                            <input  class="form-control input-lg" value="{{ $name_user}}" readonly>
        ...
        <div class="block-content">   
                <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;"><span style="border-radius: 5px;font-size: 18px;">&nbsp;&nbsp;ข้อมูลที่อยู่อาศัยปัจจุบัน&nbsp;&nbsp;</span></h2>     
                        ...
                        <div class="col-lg-3">
                                ...
                                <div class="form-group">
                                        <div class="row">
                                                ...
                                                <div class="col-lg-7"> 
                                                        <input name="HR_ZIPCODE" id="HR_ZIPCODE" class="form-control input-lg"   value="{{ $inforpersons -> HR_ZIPCODE }}" onkeyup="checkzipcodename()">
                        ...
                        <div class="col-lg-3">
                                ...
                                <div class="row">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-7"> 
                                                        <input name="HR_ZIPCODE_1" id="HR_ZIPCODE_1" class="form-control input-lg"  value="{{ $inforpersons -> HR_ZIPCODE_1 }}" style=" font-family: 'Kanit', sans-serif;" onkeyup="checkzipcodename1()" value="">
                        ...
                        <div align="right"><button type="submit"  class="btn btn-hero-sm btn-hero-info" ><i class="fas fa-save"></i> &nbsp;บันทึกแก้ไขข้อมูล</button>&nbsp;&nbsp;<a  href="{{ url('manager_person/inforperson')}}"   class="btn btn-hero-sm btn-hero-danger"  onclick="return confirm('ต้องการที่จะยกเลิกการแก้ไข ?')"><i class="fas fa-window-close"></i> &nbsp;ยกเลิก</a>  </div><br>  
