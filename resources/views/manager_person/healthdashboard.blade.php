...
<div class="block mb-4" style="width: 95%;margin:auto">
    <div class="block-content">
        <div class="block-header block-header-default">
            <h3 class="block-title text-center fs-24">ข้อมูลการตรวจสุขภาพประจำปี</h3>
        </div>
        <hr>
...
<script type="text/javascript">
    ...
    function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['ผลสุขภาพ', 'ร้อยละ'],
          ['ป่วย',<?php echo $totalhealth_1; ?>],
          ['เสี่ยง',<?php echo $totalhealth_2; ?>],
          ['สุขภาพดี',<?php echo $totalhealth_3; ?>]
        ]);
