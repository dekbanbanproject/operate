...
<br>
<b style="font-size: 20px;">ใบแสดงรายละเอียดการจ่ายเงินเดือน/ค่าจ้าง/เจ้าหน้าที่ {{$infoorg->ORG_NAME}}</b>                                                                                  
<br>
...
<br><br>
                <table class="gwt-table table-striped table-vcenter js-dataTable-full" width="100%">
                    <thead >
                        <tr height="40">
                            <th  class="text-font" style="text-align: center;" >รายละเอียด รายรับ</th>
                            <th  class="text-font" style="text-align: center;" width="30%">หมายเหตุ</th>                          
                            <th  class="text-font" style="text-align: center;" width="15%">รายรับ</th>
                ...
                <table class="gwt-table table-striped table-vcenter js-dataTable-full" width="100%">
                    <thead >
                        <tr height="40">
                            <th  class="text-font" style="text-align: center;" >รายละเอียด รายจ่าย</th>
                            <th  class="text-font" style="text-align: center;" width="30%">หมายเหตุ</th>                          
                            <th  class="text-font" style="text-align: center;" width="15%">รายจ่าย</th>
