...
@csrf
      ...
      <input type="hidden"  name="TREASURT_PAY_SAVE_HR_NAME" id="TREASURT_PAY_SAVE_HR_NAME" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" value="{{$inforpersonuser->HR_FNAME}} {{$inforpersonuser->HR_LNAME}}">
        ...
        <select name="TREASURT_PAY_REQUEST_HR_ID" id="TREASURT_PAY_REQUEST_HR_ID" class="form-control input-sm " style=" font-family: 'Kanit', sans-serif;" >
       ...
       <table class="table-striped table-vcenter " style="width: 100%;border: 1px solid black;">
        ...
        <a href="{{ url('general_warehouse/infopayindex/'.$inforpersonuserid->ID)  }}" class="btn btn-danger btn-lg" onclick="return confirm('ต้องการที่จะยกเลิกการจ่ายวัสดุ ?')" style="font-family: 'Kanit', sans-serif; font-size: 10px;font-size: 1.0rem;font-weight:normal;">ยกเลิก</a>
        </div>
