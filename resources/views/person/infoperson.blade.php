...
<style>
        body {
            ...
            font-size: 14px;
                ...
                <div class="bg-body-light">
                    <div class="content content-full">
                        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                            <h1  style="font-family: 'Kanit', sans-serif; font-size:15px;font-size: 1.3rem;font-weight:normal;">{{ $inforpersons -> HR_PREFIX_NAME }}   {{ $inforpersons -> HR_FNAME }}  {{ $inforpersons -> HR_LNAME }}</h1>
                ...
                <form method="post" action="{{ url('editpersoninfouser/'.$infoid -> ID)}}"  enctype="multipart/form-data" class="needs-validation" novalidate>
                ...
                <div class="block-header block-header-default ">
                            <h3 class="block-title" style="font-family: 'Kanit', sans-serif;"><B>แก้ไขรายละเอียดข้อมูลบุคคล</B></h3>
                </div>
                        ...
                        <div class="row push">
                                <div class="col-lg-4">
                                        ...
                                        @if ( $inforpersons->HR_IMAGE == Null )
                                                <img id="image_upload_preview" src="{{asset('image/pers.png')}}" height="60%" width="60%"> 
                                        @else
                                        <img id="image_upload_preview" src="data:image/png;base64,{{ chunk_split(base64_encode($inforpersons->HR_IMAGE)) }}" height="230px" width="200px"> 
                                        @endif
                                ...
                                <div class="col-lg-4">
                                        ...
                                        <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9">
                                                            <input  class="form-control input-lg" value="{{ Auth::user()->username}}" readonly>
                                ...
                                <div class="form-group">
                                        <div class="row">
                                                ...
                                                <div class="col-lg-9">
                                                <select name = "HR_PREFIX" class="form-control input-lg">
                                                @foreach ($infoprefixs as $infoprefix)
                                                {{ $infoprefix -> HR_PREFIX_ID }}
                                                {{ $infoprefix -> HR_PREFIX_NAME }}

                                                @if($inforpersons -> HR_PREFIX_ID  == $infoprefix -> HR_PREFIX_ID )
                                                 <option value=" {{ $infoprefix -> HR_PREFIX_ID }}" selected>{{ $infoprefix -> HR_PREFIX_NAME }}</option>
                                                @else
                                 ...
                                 <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9">
                                                <input name = "HR_FNAME" id="HR_FNAME" class="form-control input-lg" value="{{ $inforpersons -> HR_FNAME }}" onkeyup="checkname()">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <div class="col-lg-9">
                                                <input name ="HR_LNAME" id="HR_LNAME" class="form-control input-lg" value="{{ $inforpersons -> HR_LNAME }}" onkeyup="checklastname()">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <div class="col-lg-9">
                                                <input name ="HR_EN_NAME" id="HR_EN_NAME" class="form-control input-lg" value="{{ $inforpersons -> HR_EN_NAME }}" >
                                        ...
                                        <div class="form-group">
                                                ...
                                                <div class="col-lg-9">
                                                <input name ="NICKNAME" id="NICKNAME" class="form-control input-lg" value="{{ $inforpersons -> NICKNAME }}" >
                                        ...
                                        <div class="form-group">
                                                ...
                                                <div class="col-lg-9">
                                                <input name="HR_BIRTHDAY" id="HR_BIRTHDAY" class="form-control input-lg datepicker" data-date-format="mm/dd/yyyy" value="{{ formate($inforpersons -> HR_BIRTHDAY) }}" onchange="checkbirthdate()" readonly>
                                       ...
                                       <div id="birthdate"></div>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                <input name="HR_CID" id="HR_CID"class="form-control input-lg" value="{{ $inforpersons->HR_CID }}" style=" font-family: 'Kanit', sans-serif;" OnKeyPress="return chkNumber(this)" maxlength="13" onkeyup="checkhrid()" oncontextmenu="checkhrid()">
                                                ...
                                                <div class="row">
                                                 <div class="col-lg-5"> 
                                                        ...
                                                        <div class="col-lg-7">
                                                        <select name="HR_MARRY_STATUS" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onchange="checkmarry()">
                                                         @foreach ($infomarrys as $infomarry)
                                                                 {{ $infomarry -> HR_MARRY_STATUS_ID }}
                                                                 {{ $infomarry -> HR_MARRY_STATUS_NAME }}

                                                        @if($inforpersons -> HR_MARRY_STATUS_ID  == $infomarry -> HR_MARRY_STATUS_ID )
                                                ...
                                                <div class="row">
                                                 <div class="col-lg-5"> 
                                                        ...
                                                        <div class="col-lg-7">
                                                        <select name="HR_RELIGION" class="form-control input-lg">
                                                         @foreach ($inforeligions as $inforeligion)
                                                                 {{ $inforeligion -> HR_RELIGION_ID }}
                                                                 {{ $inforeligion -> HR_RELIGION_NAME }}

                                                        @if($inforpersons -> HR_RELIGION_ID  == $inforeligion -> HR_RELIGION_ID )
                                ...
                                <div class="col-lg-3"> 
                                                        ...
                                                        <div class="col-lg-9">
                                                        <select name="HR_NATIONALITY" class="form-control input-lg">
                                                         @foreach ($infonations as $infonation)
                                                                 {{ $infonation -> HR_NATIONALITY_ID }}
                                                                 {{ $infonation -> HR_NATIONALITY_NAME }}

                                                        @if($inforpersons -> HR_NATIONALITY_ID  == $infonation -> HR_NATIONALITY_ID )
                                                ...
                                                <div class="row">
                                                 <div class="col-lg-3"> 
                                                        ...
                                                        <div class="col-lg-9">
                                                        <select name="HR_CITIZENSHIP" class="form-control input-lg">
                                                         @foreach ($infocitizens as $infocitizen)
                                                                 {{ $infocitizen -> HR_CITIZENSHIP_ID }}
                                                                 {{ $infocitizen -> HR_CITIZENSHIP_NAME }}

                                                        @if($inforpersons -> HR_CITIZENSHIP_ID  == $infocitizen -> HR_CITIZENSHIP_ID )
                                                ...
                                                <div class="row">
                                                 <div class="col-lg-3"> 
                                                        ...
                                                        <select name="SEX" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onchange="checksex()">
                                                         @foreach ($infosexs as $infosex)
                                                                 {{ $infosex -> SEX_ID }}
                                                                 {{ $infosex -> SEX_NAME }}

                                                        @if($inforpersons -> SEX  == $infosex -> SEX_ID )
                                                ...
                                                <div class="row">
                                                 <div class="col-lg-3"> 
                                                        ...
                                                        <select name="HR_BLOODGROUP" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onchange="checkbloodgroup()">
                                                         @foreach ($infobloods as $infoblood)
                                                                 {{ $infoblood -> HR_BLOODGROUP_ID }}
                                                                 {{ $infoblood -> HR_BLOODGROUP_NAME }}

                                                        @if($inforpersons -> HR_BLOODGROUP_ID  == $infoblood -> HR_BLOODGROUP_ID )
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="col-lg-6"> 
                                                        <input name="HR_HIGH" id="HR_HIGH"class="form-control input-lg" value="{{ $inforpersons -> HR_HIGH }}" style=" font-family: 'Kanit', sans-serif;" OnKeyPress="return chkNumber(this)" >
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="col-lg-6">         
                                                        <input name="HR_WEIGHT" id="HR_WEIGHT"class="form-control input-lg" value="{{ $inforpersons -> HR_WEIGHT }}" style=" font-family: 'Kanit', sans-serif;" OnKeyPress="return chkNumber(this)" >
                                                 ...
                                                 <div class="row">
                                                        ...
                                                        <div class="col-lg-9">
                                                        <input name="HR_PHONE" id="HR_PHONE" class="form-control input-lg" value="{{ $inforpersons -> HR_PHONE }}" style=" font-family: 'Kanit', sans-serif;" OnKeyPress="return chkNumber(this)" maxlength="10" >
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="col-lg-9">
                                                        <input name="HR_EMAIL"   id="HR_EMAIL" class="form-control input-lg" value="{{ $inforpersons -> HR_EMAIL  }}" style=" font-family: 'Kanit', sans-serif;" onkeyup="checkemail()">
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="col-lg-9">
                                                        <input name="HR_FACEBOOK"  class="form-control input-lg" value="{{ $inforpersons -> HR_FACEBOOK }}">
                                                        </div>
                                                </div>
                                         </div>
                                                <div class="form-group">
                                                <div class="row">
                                                        ...
                                                        <div class="col-lg-9">
                                                        <input name="HR_LINE"  class="form-control input-lg" value="{{ $inforpersons -> HR_LINE }}">
                                                        </div>
                                                </div>
                                         </div>
                        ...
                        <div class="block-content">  
                                <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;"><span style="border-radius: 5px;font-size: 18px;">&nbsp;&nbsp;ข้อมูลอาชีพ&nbsp;&nbsp;</span></h2>     
                                        <div class="row push">
                                                        ...
                                                        <div class="form-group">
                                                                <div class="row">
                                                                        ...
                                                                        @foreach ($infodepartments as $infodepartment) 
                                                                                @if($infodepartment ->HR_DEPARTMENT_ID == $inforpersons ->HR_DEPARTMENT_ID)
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <option value="{{ $inforpersons ->HR_DEPARTMENT_SUB_ID  }}">{{ $inforpersons->HR_DEPARTMENT_SUB_NAME  }}</option>
                                                        </select>
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <option value="{{ $inforpersons ->HR_DEPARTMENT_SUB_SUB_ID  }}">{{ $inforpersons->HR_DEPARTMENT_SUB_SUB_NAME  }}</option>
                                                ...
                                                <div class="row">
                                                        <div class="col-lg-3"> 
                                                        <label>วันที่บรรจุ <div style="color: red;" id="startworkdate"></div></label>
                                                        </div>
                                                        <div class="col-lg-9">
                                                        <input name="STARTWORK" id="STARTWORK" class="form-control input-lg datepicker" style=" font-family: 'Kanit', sans-serif;" data-date-format="mm/dd/yyyy" value="{{ formate($inforpersons -> HR_STARTWORK_DATE) }}" onchange="checkstartworkdate()" readonly>
                                                        </div>
                                                </div>
                                         </div>
                                                <div class="form-group">
                                                <div class="row">
                                                        ...
                                                        <div class="col-lg-9">
                                                        <input name="HR_POSITION_NUM" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" style=" font-family: 'Kanit', sans-serif;" value="{{ $inforpersons -> HR_POSITION_NUM }}" >
                                                        </div>
                                                </div>
                                         </div>  
                                                <div class="form-group">
                                                <div class="row">
                                                        ...
                                                        <div class="col-lg-7">
                                                        <input name="VCODE" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{ $inforpersons -> VCODE }}">
                                                        </div>
                                                </div>
                                         </div>  
                                ...
                                <div class="col-lg-4">
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="col-lg-7">
                                                        <input name="VCODE_DATE" id="VCODE_DATE" class="form-control input-lg datepicker" style=" font-family: 'Kanit', sans-serif;" data-date-format="mm/dd/yyyy" value="{{ formate($inforpersons -> VCODE_DATE) }}" readonly>
                                                        </div>
                                                </div>
                                         </div>  
                                                <div class="form-group">
                                                <div class="row">
                                                        ...
                                                        <option value="" >--กรุณาเลือกตำแหน่ง--</option>
                                                         @foreach ($infopositions as $infoposition)  inforpersons
                                                                @if($infoposition ->HR_POSITION_ID == $inforpersons ->HR_POSITION_ID)
                                                ...
                                                <div class="row">
                                                        ...
                                                        <option value="" >--กรุณาเลือกระดับ--</option>
                                                         @foreach ($infolevels as $infolevel) 
                                                                @if($infolevel ->HR_LEVEL_ID == $inforpersons ->HR_LEVEL_ID)
                                                ...
                                                <div class="row">
                                                        ...
                                                        <option value="" >--กรุณาเลือกสถานะ--</option>
                                                         @foreach ($infostatuss as $infostatus)
                                                                @if($infostatus ->HR_STATUS_ID == $inforpersons ->HR_STATUS_ID)
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="col-lg-7">
                                                        <select name="HR_KIND" id="HR_KIND" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" >
                                                        <option value="" >--กรุณาเลือกกลุ่มข้าราชการ--</option>
                                                         @foreach ($infokinds as $infokind) 
                                                                @if($infokind ->HR_KIND_ID  == $inforpersons ->HR_KIND_ID)
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="col-lg-7">
                                                        <select name="HR_KIND_TYPE" id="HR_KIND_TYPE" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" >
                                                        <option value="" >--กรุณาเลือกประเภทข้าราชการ--</option>
                                                         @foreach ($infokind_types as $infokind_type) 
                                                                @if($infokind_type ->HR_KIND_TYPE_ID  == $inforpersons ->HR_KIND_TYPE_ID)
                                ...
                                <div class="col-lg-4">
                                                ...
                                                <div class="row">
                                                        ...
                                                        <option value="" >--กรุณาเลือกกลุมบุคคลากร--</option>
                                                         @foreach ($infoperson_types as $infoperson_type)   
                                                                @if($infoperson_type ->HR_PERSON_TYPE_ID  == $inforpersons ->HR_PERSON_TYPE_ID)
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="col-lg-7">
                                                        <input name="HR_AGENCY_ID" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{$inforpersons ->HR_AGENCY_ID}}">
                                                        </div>
                                                </div>
                                         </div>       
                                                <div class="form-group">
                                                <div class="row">
                                                        ...
                                                        <div class="col-lg-7">
                                                        <input name="HR_SALARY" id="HR_SALARY" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" OnKeyPress="return chkmunny(this)" value="{{ $inforpersons -> HR_SALARY }}"  onkeyup="checkhrsalary()">
                                                ...
                                                <div class="row">
                                                        <div class="col-lg-5">
                                                        <label>เงินประจำตำแหน่ง <div style="color: red;" id="moneyposition"></div></label>
                                                        </div>
                                                        <div class="col-lg-7">
                                                        <input name="MONEY_POSITION" id="MONEY_POSITION" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" OnKeyPress="return chkmunny(this)" value="{{ $inforpersons -> MONEY_POSITION }}">
                                                        </div>
                                                </div>
                                         </div>                        
                                        ...
                                        <div class="row push">
                                                <div class="col-lg-4">
                                                                ...
                                                                <div class="form-group">
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                        <input class="form-control input-lg" value="{{ $inforpersons -> HR_DEPARTMENT_NAME }}" readonly>
                
                                                                        <input type="hidden" name="HR_DEPARTMENT" id="HR_DEPARTMENT" class="form-control input-lg" value="{{ $inforpersons ->HR_DEPARTMENT_ID }}" >                        
                                                                ...
                                                                <div class="col-lg-3">
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                        <input  class="form-control input-lg" value="{{ $inforpersons -> HR_DEPARTMENT_SUB_NAME }}" readonly>
                                                                        <input type = "hidden" name="DEPARTMENT_SUB" id="DEPARTMENT_SUB" class="form-control input-lg" value="{{ $inforpersons ->HR_DEPARTMENT_SUB_ID }}" >    
                                                                        </div>
                                                                        </div>
                                                                        </div>
                                                                <div class="form-group">
                                                                        ...
                                                                        <label>หน่วยงาน </label>
                                                                         ...
                                                                         <div class="col-lg-9">
                                                                        <input class="form-control input-lg" value="{{ $inforpersons -> HR_DEPARTMENT_SUB_SUB_NAME }}" readonly>
                                                                        <input type = "hidden" name="HR_DEPARTMENT_SUB_SUB" id="HR_DEPARTMENT_SUB_SUB" class="form-control input-lg" value="{{ $inforpersons ->HR_DEPARTMENT_SUB_SUB_ID }}" > 
                                                                        </div>
                                                                        </div>
                                                                        </div>
                                                                <div class="form-group">
                                                                ...
                                                                <div class="col-lg-3"> 
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                        <input name="STARTWORK" id="STARTWORK" class="form-control input-lg" value="{{ formate($inforpersons -> HR_STARTWORK_DATE)}}" readonly>
                                                                ...
                                                                <div class="form-group">
                                                                        ...
                                                                        <label>เลขตำแหน่ง </label>
                                                                         ...
                                                                         <div class="col-lg-9">
                                                                        <input name="HR_POSITION_NUM" class="form-control input-lg" value="{{ $inforpersons -> HR_POSITION_NUM }}" readonly>
                                                                        </div>
                                                                        </div>
                                                                        </div>   
                                                ...
                                                <div class="col-lg-4">
                                                                ...
                                                                <div class="col-lg-5"> 
                                                                        ...
                                                                        <div class="col-lg-7">
                                                                        <input name="VCODE" class="form-control input-lg" value="{{ $inforpersons -> VCODE }}" readonly>
                                                                        </div>
                                                                        </div>
                                                                        </div>  
                                                                <div class="form-group">
                                                                <div class="row">
                                                                 <div class="col-lg-5"> 
                                                                        ...
                                                                        <input name="VCODE_DATE" id="VCODE_DATE" class="form-control input-lg" value="{{ formate($inforpersons -> VCODE_DATE) }}" readonly>
                                                                        </div>
                                                                        </div>
                                                                        </div>
                                                                <div class="form-group">
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                        <input  class="form-control input-lg" value="{{ $inforpersons -> POSITION_IN_WORK }}" readonly>
                                                                        <input type = "hidden" name="POSITION_IN_WORK" id="POSITION_IN_WORK" class="form-control input-lg" value="{{ $inforpersons ->HR_POSITION_ID }}" > 
                                                                        </div>
                                                                        </div>
                                                                        </div>
                                                                <div class="form-group">
                                                                ...
                                                                <div class="col-lg-3">
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                        <input class="form-control input-lg" value="{{ $inforpersons -> HR_LEVEL_NAME}}" readonly>
                                                                        <input type = "hidden" name="HR_LEVEL" id="HR_LEVEL" class="form-control input-lg" value="{{ $inforpersons ->HR_LEVEL_ID }}" >
                                                                        </div>
                                                                        </div>
                                                                        </div>
                                                                <div class="form-group">
                                                                        ...
                                                                        <div class="col-lg-7">
                                                                        <input class="form-control input-lg" value="{{ $inforpersons -> HR_STATUS_NAME }}" readonly>
                                                                        <input type = "hidden" name="HR_STATUS" id="HR_STATUS" class="form-control input-lg" value="{{ $inforpersons ->HR_STATUS_ID }}" >
                                                                        </div>
                                                                        </div>
                                                                        </div>
                                                                ...
                                                                <div class="row">
                                                                 <div class="col-lg-5"> 
                                                                        <label>กลุ่มข้าราชการ </label>
                                                                         ...
                                                                         <div class="col-lg-7">
                                                                        <input class="form-control input-lg" value="{{ $inforpersons -> HR_KIND_NAME }}" readonly>
                                                                        <input type = "hidden" name="HR_KIND" id="HR_KIND" class="form-control input-lg" value="{{ $inforpersons ->HR_KIND_ID }}" >
                                                                        </div>
                                                                        </div>
                                                                        </div>
                                                                <div class="form-group">
                                                                        ...
                                                                        <div class="col-lg-7">
                                                                        <input class="form-control input-lg" value="{{ $inforpersons -> HR_KIND_TYPE_NAME }}" readonly>
                                                                        <input type = "hidden" name="HR_KIND_TYPE" id="HR_KIND_TYPE" class="form-control input-lg" value="{{ $inforpersons ->HR_KIND_TYPE_ID }}" >
                                                                        </div>
                                                                        </div>
                                                                        </div>
                                                                <div class="form-group">
                                                                        ...
                                                                        <div class="col-lg-7">
                                                                        <input class="form-control input-lg" value="{{ $inforpersons -> HR_PERSON_TYPE_NAME }}" readonly>
                                                                        <input type = "hidden" name="HR_PERSON_TYPE" id="HR_PERSON_TYPE" class="form-control input-lg" value="{{ $inforpersons ->HR_PERSON_TYPE_ID }}" >
                                                                        </div>
                                                                        </div>
                                                                        </div> 
                                                                <div class="form-group">
                                                                        ...
                                                                        <div class="col-lg-7">
                                                                        <input name="" class="form-control input-lg" value="{{ $inforpersons -> HOS_USE_CODE }}" readonly>
                                                                        </div>
                                                                        </div>
                                                                        </div>   
                                                                <div class="form-group">
                                                                        ...
                                                                        <div class="col-lg-7">
                                                                        <input name="HR_SALARY" id="HR_SALARY" class="form-control input-lg" value="{{ $inforpersons -> HR_SALARY }}" readonly>
                                                                        </div>
                                                                        </div>
                                                                        </div>       
                                                                <div class="form-group">
                                                                        ...
                                                                        <label>เงินประจำตำแหน่ง </label>
                                                                         ...
                                                                         <div class="col-lg-7">
                                                                        <input name="MONEY_POSITION" id="MONEY_POSITION" class="form-control input-lg" value="{{ $inforpersons -> MONEY_POSITION }}" readonly>
                                                                        </div>
                                                                        </div>
                                                                        </div>          
                ...
                <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;"><span style="border-radius: 5px;font-size: 18px;">&nbsp;&nbsp;ข้อมูลที่อยู่อาศัยปัจจุบัน&nbsp;&nbsp;</span></h2>     
                        <div class="row"> 
                                <div class="col-lg-3">
                                        ...
                                        <div class="col-lg-8"> 
                                        <input name="HR_HOME_NUMBER"  id="HR_HOME_NUMBER" class="form-control input-lg"  value="{{ $inforpersons -> HR_HOME_NUMBER }}" style=" font-family: 'Kanit', sans-serif;" onkeyup="checkhomenumber()" >
                                        ...
                                        <option value=" {{ $inforpersons -> PROVINCE_ID }}">{{ $inforpersons -> PROVINCE_NAME }}</option>
                                ...
                                <label>หมู่ที่ </label>
                                        ...
                                        <div class="col-lg-8"> 
                                <input name="HR_VILLAGE_NO" id="HR_VILLAGE_NO" class="form-control input-lg"   value="{{ $inforpersons -> HR_VILLAGE_NO }}"style=" font-family: 'Kanit', sans-serif;" onkeyup="checkvillageno()" >
                                ...
                                <option value=" {{ $inforpersons -> AMPHUR_ID }}">{{ $inforpersons -> AMPHUR_NAME }}</option>
                                <?php $infoamphures = DB::table('hrd_amphur')->where('PROVINCE_ID','=',$inforpersons -> PROVINCE_ID)->get(); ?>
                                   
                                   @foreach ($infoamphures as $infoamphure)                               
                                             
                                             <option value=" {{ $infoamphure -> ID }}" >{{ $infoamphure -> AMPHUR_NAME }}</option>
                                ...
                                <label>ถนน </label>
                                                        ...
                                                        <div class="col-lg-8"> 
                                                        <input name="HR_ROAD_NAME" class="form-control input-lg"   value="{{  $inforpersons -> HR_ROAD_NAME }}">
                                                        </div>
                                                        </div>
                                                        </div>
                                                <div class="form-group">
                                                <div class="row">
                                                        ...
                                                        <option value=" {{ $inforpersons -> TUMBON_ID }}">{{ $inforpersons -> TUMBON_NAME }}</option>
                                                        <?php $infohrdtumbons = DB::table('hrd_tumbon')->where('AMPHUR_ID','=',$inforpersons -> AMPHUR_ID)->get(); ?>
                                   
                                                                        @foreach ($infohrdtumbons as $infohrdtumbon)                               
                                             
                                                                                <option value=" {{ $infohrdtumbon -> ID }}" >{{ $infohrdtumbon -> TUMBON_NAME }}</option>
                        ...
                        <div class="col-lg-3">
                                <div class="form-group">
                                        <div class="row">
                                                ...
                                                <div class="col-lg-8"> 
                                                    <input name="HR_SOI_NAME" class="form-control input-lg"   value="{{ $inforpersons -> HR_SOI_NAME }}">
                                                </div>
                                        </div> 
                                </div> 
                                <div class="form-group">
                                        <div class="row">
                                                ...
                                                <div class="col-lg-7"> 
                                                        <input name="HR_ZIPCODE" id="HR_ZIPCODE" class="form-control input-lg"   value="{{ $inforpersons -> HR_ZIPCODE }}" maxlength="5" onkeyup="checkzipcodename()">
                        ...
                        <div class="col-lg-3">
                                        ...
                                        <div class="col-lg-8"> 
                                        <input name="HR_HOME_NUMBER_1" id="HR_HOME_NUMBER_1" class="form-control input-lg"  value="{{ $inforpersons -> HR_HOME_NUMBER_1 }}" style=" font-family: 'Kanit', sans-serif;" onchange="checkhomenumber1()">
                                        ...
                                        <select name="PROVINCE_NAME_1" id="PROVINCE_NAME_1" class="form-control input-lg provice_sub" style=" font-family: 'Kanit', sans-serif;" onchange="checkprovincename1()">
                                                        <option value=" {{ $inforperson_add1 -> PROVINCE_ID_1 }}">{{ $inforperson_add1 -> PROVINCE_NAME }}</option>
                                                        @foreach ($infoprovinces as $infoprovince)                               
                                ...
                                <label>หมู่ที่ </label>
                                        ...
                                        <div class="col-lg-8"> 
                                        <input name="HR_VILLAGE_NO_1" id="HR_VILLAGE_NO_1" class="form-control input-lg"  value="{{ $inforpersons -> HR_VILLAGE_NO_1   }}" style=" font-family: 'Kanit', sans-serif;" onkeyup="checkvillageno1()">
                                ...
                                <label>อำเภอ </label>
                                        ...
                                        <select name="AMPHUR_NAME_1" id="AMPHUR_NAME_1" class="form-control input-lg amphures_sub" style=" font-family: 'Kanit', sans-serif;" onchange="checkamphurname1()">
                                                        <option value=" {{ $inforperson_add1 -> AMPHUR_ID_1 }}">{{ $inforperson_add1 -> AMPHUR_NAME }}</option>
                                                        <?php $infoamphures_add1 = DB::table('hrd_amphur')->where('PROVINCE_ID','=',$inforperson_add1 -> PROVINCE_ID)->get(); ?>
                                   
                                                                @foreach ($infoamphures_add1 as $infoamphure_add1)                               
                                           
                                                                         <option value=" {{ $infoamphure_add1 -> ID }}" >{{ $infoamphure_add1 -> AMPHUR_NAME }}</option>
                                ...
                                <label>ถนน </label>
                                                        ...
                                                        <div class="col-lg-8"> 
                                                        <input name="HR_ROAD_NAME_1" class="form-control input-lg"  value="{{  $inforpersons -> HR_ROAD_NAME_1 }}">
                                                        </div>
                                                        </div>
                                                        </div>
                                                <div class="form-group">
                                                <div class="row">
                                                        ...
                                                        <option value=" {{ $inforperson_add1 -> TUMBON_ID_1 }}">{{ $inforperson_add1 -> TUMBON_NAME }}</option>
                                                        
                                                        <?php $infohrdtumbons_add1 = DB::table('hrd_tumbon')->where('AMPHUR_ID','=',$inforperson_add1 -> AMPHUR_ID)->get(); ?>
                                                                        
                                                                        @foreach ($infohrdtumbons_add1 as $infohrdtumbon_add1)                               
                                                                                
                                                                                <option value=" {{ $infohrdtumbon_add1 -> ID }}" >{{ $infohrdtumbon_add1 -> TUMBON_NAME }}</option>
                                        
                                                                        @endforeach 
                                                        </select>
                                                        <div style="color: red;" id="tumbonname1"></div>
                                                        <div id="tumbonname1"></div>
                                                        </div>
                                                        {{csrf_field()}} 
                                        </div>
                                        </div>
                                ...
                                <div class="row">
                                                        ...
                                                        <div class="col-lg-8"> 
                                                        <input name="HR_SOI_NAME_1" class="form-control input-lg"   value="{{ $inforpersons -> HR_SOI_NAME_1 }}">
                                                    </div>
                                                    </div> 
                                                    </div>   
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-7"> 
                                                        <input name="HR_ZIPCODE_1" id="HR_ZIPCODE_1" class="form-control input-lg"  value="{{ $inforpersons -> HR_ZIPCODE_1 }}" style=" font-family: 'Kanit', sans-serif;" maxlength="5" onkeyup="checkzipcodename1()" value="">
                        ...
                        <div class="row">
                                <div class="col-lg-4">
                                                ...
                                                <div class="form-group">
                                                 ...
                                                 <div class="row">
                                                        ...
                                                        <div class="col-lg-8"> 
                                                        <input name="BOOK_BANK_NUMBER" class="form-control input-lg" value="{{ $inforpersons -> BOOK_BANK_NUMBER }}">
                                                </div>
                                                </div>
                                                </div>
                                                <div class="form-group">
                                                <div class="row">
                                                        ...
                                                        <div class="col-lg-8"> 
                                                        <input name="BOOK_BANK_NAME" class="form-control input-lg" value="{{ $inforpersons -> BOOK_BANK_NAME }}">
                                                        </div>
                                                </div>
                                                </div>
                                                <div class="form-group">
                                                <div class="row">
                                                        ...
                                                        <div class="col-lg-8"> 
                                                        <input name="BOOK_BANK" class="form-control input-lg" value="{{ $inforpersons -> BOOK_BANK }}">
                                                        </div>
                                                </div>
                                                </div>
                                                <div class="form-group">
                                                <div class="row">
                                                        ...
                                                        <div class="col-lg-8"> 
                                                        <input name="BOOK_BANK_BRANCH" class="form-control input-lg" value="{{ $inforpersons -> BOOK_BANK_BRANCH }}">
                                                        </div>
                                                </div>
                                                </div>
                                ...
                                <div class="col-lg-4">
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="col-lg-8"> 
                                                        <input name="BOOK_BANK_OT_NUMBER" class="form-control input-lg" value="{{ $inforpersons -> BOOK_BANK_OT_NUMBER }}">
                                                        </div>
                                                </div>
                                                </div>
                                                <div class="form-group">
                                                <div class="row">
                                                        ...
                                                        <div class="col-lg-8"> 
                                                        <input name="BOOK_BANK_OT_NAME" class="form-control input-lg" value="{{ $inforpersons -> BOOK_BANK_OT_NAME }}">
                                                        </div>
                                                </div>
                                                </div>
                                                <div class="form-group">
                                                <div class="row">
                                                        ...
                                                        <div class="col-lg-8"> 
                                                        <input name="BOOK_BANK_OT" class="form-control input-lg" value="{{ $inforpersons -> BOOK_BANK_OT }}">
                                                        </div>
                                                </div>
                                                </div>
                                                <div class="form-group">
                                                <div class="row">
                                                        ...
                                                        <div class="col-lg-8"> 
                                                        <input name="BOOK_BANK_OT_BRANCH" class="form-control input-lg" value="{{ $inforpersons -> BOOK_BANK_OT_BRANCH }}">
                                                        </div>
                                                </div>
                                                </div>
                        ...
                        <div align="right"><button type="submit"  class="btn btn-hero-sm btn-hero-info" ><i class="fas fa-save"></i> &nbsp;บันทึกแก้ไขข้อมูล</button>&nbsp;&nbsp;<a href="{{ url('person/personinfouser/'.$infoid -> ID)  }}" class="btn btn-hero-sm btn-hero-danger"  onclick="return confirm('ต้องการที่จะยกเลิกการแก้ไข ?')"><i class="fas fa-window-close"></i> &nbsp;ยกเลิก</a>  </div><br> 
