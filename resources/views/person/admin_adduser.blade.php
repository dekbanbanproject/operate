                        ...
                        <div class="col-lg-4">
                                ...
                                <div class="form-group">
                                        <div class="row">
                                                ...
                                                <div class="col-lg-9">
                                                        <input name ="HR_EN_NAME" id="HR_EN_NAME" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" >
                                ...
                                <div class="form-group">
                                        <div class="row">
                                                ...
                                                <div class="col-lg-9">
                                                        <input name ="NICKNAME" id="NICKNAME" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" >
                                ...
                                <div class="form-group">
                                        <div class="row">
                                                <div class="col-lg-3">
                                                        ...
                                                        <div class="col-lg-9">                                              
                                                        <input name="HR_BIRTHDAY" id="birthdate" class="form-control input-lg datepicker  {{ $errors->has('HR_BIRTHDAY') ? 'is-invalid' : '' }}" style=" font-family: 'Kanit', sans-serif;"  data-date-format="mm/dd/yyyy" value="{{ old('HR_BIRTHDAY') }}" onchange="checkbirthdate()" readonly>
                        ...
                        <div class="col-lg-4">
                                ...
                                <div class="form-group">
                                        <div class="row">
                                                ...
                                                <div class="col-lg-6">        
                                                        <input name="HR_HIGH" id="HR_HIGH" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" OnKeyPress="return chkNumber(this)" >
                                                </div>
                                                <div class="col-lg-3"> 
                                ...
                                <div class="form-group">
                                        <div class="row">
                                                ...
                                                <div class="col-lg-6"> 
                                                        <input name="HR_WEIGHT" id="HR_WEIGHT" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" OnKeyPress="return chkNumber(this)" >
                                                </div>
                                                <div class="col-lg-3">      
                                ...
                                <div class="form-group">
                                        <div class="row">
                                                ...
                                                <div class="col-lg-9"> 
                                                        <input name="HR_PHONE" id="HR_PHONE" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" OnKeyPress="return chkNumber(this)" maxlength="10" >
                                                </div>
                                ...
                                <div class="form-group">
                                        <div class="row">
                                                <div class="col-lg-3">                         
                                                        <label>อีเมลล์ </label> <label style="color:red;"> **</label>
                                                </div>
                                                <div class="col-lg-9"> 
                                ...
                                <div class="form-group">
                                        <div class="row">
                                                <div class="col-lg-3"> 
                                                        <label>Line token </label> <label style="color:red;"> **</label>
                                                </div>
                                                <div class="col-lg-9"> 
                                ...
                                <div class="col-lg-4">                               
                                        ...
                                        <div class="form-group">
                                                <div class="row">
                                                        ...
                                                        <div class="col-lg-9">
                                                                <input name="STARTWORK" id="STARTWORK" class="form-control input-lg datepicker2 {{ $errors->has('STARTWORK') ? 'is-invalid' : '' }}" style=" font-family: 'Kanit', sans-serif;" data-date-format="mm/dd/yyyy"  onchange="checkstartworkdate()" readonly>
                                        ...
                                        <div class="form-group">
                                                <div class="row">
                                                        ...
                                                        <div class="col-lg-9">
                                                                <input name="HR_POSITION_NUM" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" style=" font-family: 'Kanit', sans-serif;" >
                                                        </div>
                                                </div>
                                        </div>    
                                        <div class="form-group">
                                ...
                                <div class="col-lg-4"> 
                                        ...
                                        <div class="form-group">
                                                <div class="row">
                                                        ...
                                                        <div class="col-lg-9">
                                                                <select name="HR_LEVEL" id="HR_LEVEL" class="form-control input-sm js-example-basic-single" style=" font-family: 'Kanit', sans-serif;">
                                        ...
                                        <div class="form-group">
                                                <div class="row">
                                                        ...
                                                        <div class="col-lg-7">               
                                                                <select name="HR_KIND" id="HR_KIND" class="form-control input-sm js-example-basic-single" style=" font-family: 'Kanit', sans-serif;" >
                                        ...
                                        <div class="form-group">
                                                <div class="row">
                                                        ...
                                                        <div class="col-lg-7"> 
                                                                <select name="HR_KIND_TYPE" id="HR_KIND_TYPE" class="form-control input-sm js-example-basic-single" style=" font-family: 'Kanit', sans-serif;" >
                                ...
                                <div class="col-lg-4">
                                        <div class="form-group">
                                                <div class="row">
                                                        ...
                                                        <div class="col-lg-7">
                                                                <select name="HR_PERSON_TYPE" id="HR_PERSON_TYPE" class="form-control input-sm js-example-basic-single" style=" font-family: 'Kanit', sans-serif;" onchange="checkhrpersontype()">
                                        ...
                                        <div class="form-group">
                                                <div class="row">
                                                        ...
                                                        <div class="col-lg-7">
                                                                <input name="" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" >
                                                        </div>
                                                </div>
                                        </div>   
                                        <div class="form-group">
                                ...
                                <div class="col-lg-3">                                       
                                        <div class="form-group">
                                                <div class="row">
                                                        ...
                                                        <div class="col-lg-8"> 
                                                                <input name="HR_HOME_NUMBER" id="HR_HOME_NUMBER" class="form-control input-lg {{ $errors->has('HR_HOME_NUMBER') ? 'is-invalid' : '' }}" value="{{ old('HR_HOME_NUMBER') }}" style=" font-family: 'Kanit', sans-serif;" onkeyup="checkhomenumber()" >
                                                         </div>
                                ...
                                <div class="col-lg-3">
                                        <div class="form-group">
                                                <div class="row">
                                                        ...
                                                        <div class="col-lg-8">
                                                                <input name="HR_ROAD_NAME" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;"   >
                                                        </div>
                                                </div>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="col-lg-3">
                                        <div class="form-group">
                                                <div class="row">
                                                        ...
                                                        <div class="col-lg-8">
                                                                <input name="HR_SOI_NAME" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;"   >
                                                        </div>  
                                                </div>
                                        </div>                               
                                        <div class="form-group">
                                                <div class="row">
                                                        ...
                                                        <div class="col-lg-7">
                                                                <input name="HR_ZIPCODE" id="HR_ZIPCODE"class="form-control input-lg {{ $errors->has('HR_ZIPCODE') ? 'is-invalid' : '' }}" value="{{ old('HR_ZIPCODE') }}" style=" font-family: 'Kanit', sans-serif;" value="" maxlength="5" onkeyup="checkzipcodename()">
                                                        </div> 
                ...
                <div class="block-content">   
                        <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;"><span style="border-radius: 5px;font-size: 18px;">&nbsp;&nbsp;ข้อมูลที่อยู่อาศัยตามทะเบียนบ้าน&nbsp;&nbsp;</span></h2>      
                                <div class="row push">        
                                        <div class="col-lg-3">
                                                <div class="form-group">
                                                        <input type="checkbox" name="billingtoo" onclick="FillBilling(this.form)" >&nbsp;&nbsp; ข้อมูลที่อยู่อาศัยปัจจุบัน &nbsp;&nbsp;<label style="color:red;"> ***</label>
                                                </div>
                                                <div class="form-group">
                                                        <div class="row">
                                                                <div class="col-lg-4">
                                        ...
                                        <div class="col-lg-3">
                                                ...
                                                <div class="form-group">
                                                        <div class="row">
                                                                ...
                                                                <div class="col-lg-8">
                                                                        <input name="HR_ROAD_NAME_1" class="form-control input-lg"  >
                                                                </div>
                                                        </div>
                                                </div>
                                                <div class="form-group">
                                        ...
                                        <div class="col-lg-3">
                                                ...
                                                <div class="form-group">
                                                        <div class="row">
                                                                ...
                                                                <div class="col-lg-8">
                                                                        <input name="HR_SOI_NAME_1" class="form-control input-lg"   >
                                                                </div>  
                                                        </div>
                                                </div>
                                                <div class="form-group">
                                ...
                                <div class="col-lg-4">
                                        ...
                                        <div class="form-group">
                                                <div class="row"> 
                                                        ...
                                                        <div class="col-lg-8"> 
                                                                <input name="BOOK_BANK_NUMBER" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" OnKeyPress="return chkNumber(this)">
                                                        </div>
                                                </div>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="col-lg-4">                                        
                                        ...
                                        <div class="form-group">
                                                <div class="row"> 
                                                        ...
                                                        <div class="col-lg-8"> 
                                                                <input name="BOOK_BANK_OT_NUMBER" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;"  OnKeyPress="return chkNumber(this)">
                                                        </div>
                                                </div>
                                        </div>
                                        <div class="form-group">
