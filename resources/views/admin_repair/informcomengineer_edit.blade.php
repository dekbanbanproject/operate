...
<div class="content">
    ...
    <form  method="post" action="{{ route('admin.updateinformcomengineer') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row push">
                        <div class="col-lg-2">
                            ...
                            <select name="PERSON_ID" id="PERSON_ID" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;font-size: 13px;" onchange="check_personid();">
                                <option value="">--เลือกชื่อ-นามสกุล--</option>
                                    @foreach ($infoperT as $infoper) 
                                        @if($infoinformcomengineerT -> PERSON_ID == $infoper-> ID  )                                                     
                    ...
                    <div class="col-lg-4">
                        ...
                        <input value="{{$infoinformcomengineerT-> ID_ENGINEER}}" type="hidden" name = "ID_ENGINEER"  id="ID_ENGINEER" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" >       
                        </div> 
            <div class="modal-footer">
                <div align="right">
                    <button type="submit"  class="btn btn-hero-sm btn-hero-info" >บันทึกข้อมูล</button>
                        <a href="{{ url('admin_repair/Setupinformcomengineer')  }}" class="btn btn-hero-sm btn-hero-danger" onclick="return confirm('ต้องการที่จะยกเลิกการเพิ่มข้อมูล ?')" >ยกเลิก</a> 
                </div>  
            </div>
    </form>  
